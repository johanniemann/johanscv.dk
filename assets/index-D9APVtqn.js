(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const Le={nav:{home:"Home",projects:"Projects",files:"Resume",contact:"Contact"},hero:{name:"Johan Niemann Husbjerg",title:"IT Architecture student shaping precise, human-centered systems."},welcome:{title:"Welcome",intro:"This site is a focused overview of my architecture profile, practical experience, and current projects.",point1:"Explore projects and implementation work.",point2:"Review my full Resume / CV structure.",point3:"Use Ask Johan for quick context.",continue:"Continue",passwordLabel:"Site access code",passwordPlaceholder:"Enter access code",passwordError:"Invalid access code. Please try again."},ask:{title:"Ask Johan",placeholder:"Ask about skills, projects, or architecture...",button:"Answer"},projects:{title:"Projects",intro:"Focused work in architecture, frontend systems, and product execution.",previewTitle:"Selected Work",previewIntro:"A snapshot of practical architecture and frontend execution.",cta:"View all projects"},files:{title:"Resume / CV",intro:"Education, experience, voluntary work, and qualifications."},fileScroller:{title:"Links and files",ariaLabel:"Links and files carousel"},resume:{previewTitle:"Resume Snapshot",previewIntro:"A structured view of my education, practical experience, and key competencies.",cta:"Open Resume / CV",downloadPdf:"Download resume as PDF",education:"Education",experience:"Work Experience",voluntary:"Voluntary Work",qualifications:"Qualifications",itSkills:"Core IT Skills",personalQualities:"Personal Qualities"},contact:{title:"Contact",intro:"Reach out directly by email, phone, or LinkedIn.",emailLabel:"Email",phoneLabel:"Phone",linkedinLabel:"LinkedIn",copyEmail:"Copy E-Mail",copyPhone:"Copy phonenumber",connectLinkedin:"Connect on LinkedIn",copied:"Copied"},playground:{title:"Experimental Playground",intro:"This is a sandbox page for testing ideas, UI experiments, and prototypes.",moreToComeTitle:"More To Come",moreToComeBody:"More experiments and interactive prototypes will be added here soon."},scrollHint:{label:"Scroll for more"},footer:{builtWith:"Built with Vite, Tailwind, and Vanilla JavaScript.",rights:"All rights reserved.",playground:"Experimental Playground"}},Ae={nav:{home:"Hjem",projects:"Projekter",files:"CV",contact:"Kontakt"},hero:{name:"Johan Niemann Husbjerg",title:"IT-arkitekturstuderende med fokus på præcise, menneskelige systemer."},welcome:{title:"Velkommen",intro:"Denne side giver et fokuseret overblik over min arkitekturprofil, praktiske erfaring og nuværende projekter.",point1:"Se projekter og konkret implementeringsarbejde.",point2:"Gennemgå mit fulde Resume / CV.",point3:"Brug Ask Johan for hurtig kontekst.",continue:"Fortsæt",passwordLabel:"Adgangskode til siden",passwordPlaceholder:"Indtast adgangskode",passwordError:"Ugyldig adgangskode. Prøv igen."},ask:{title:"Spørg Johan",placeholder:"Spørg om kompetencer, projekter eller arkitektur...",button:"Svar"},projects:{title:"Projekter",intro:"Fokuseret arbejde inden for arkitektur, frontend-systemer og produktudførelse.",previewTitle:"Udvalgt Arbejde",previewIntro:"Et udsnit af praktisk arkitektur og frontend-udførelse.",cta:"Se alle projekter"},files:{title:"Resume / CV",intro:"Uddannelse, arbejdserfaring, frivilligt arbejde og kvalifikationer."},fileScroller:{title:"Links og filer",ariaLabel:"Karusel med links og filer"},resume:{previewTitle:"CV overblik",previewIntro:"Et struktureret overblik over uddannelse, praktisk erfaring og væsentlige kompetencer.",cta:"Åbn Resume / CV",downloadPdf:"Download resume som PDF",education:"Uddannelse",experience:"Arbejdserfaring",voluntary:"Frivilligt arbejde",qualifications:"Kvalifikationer",itSkills:"Væsentlige IT-kundskaber",personalQualities:"Personlige kvaliteter"},contact:{title:"Kontakt",intro:"Kontakt mig direkte via e-mail, telefon eller LinkedIn.",emailLabel:"E-mail",phoneLabel:"Telefon",linkedinLabel:"LinkedIn",copyEmail:"Kopiér e-mail",copyPhone:"Kopiér telefonnummer",connectLinkedin:"Forbind på LinkedIn",copied:"Kopieret"},playground:{title:"Eksperimentelt Playground",intro:"Dette er en sandbox-side til at teste ideer, UI-eksperimenter og prototyper.",moreToComeTitle:"Mere På Vej",moreToComeBody:"Flere eksperimenter og interaktive prototyper bliver tilføjet her snart."},scrollHint:{label:"Scroll for mere"},footer:{builtWith:"Bygget med Vite, Tailwind og Vanilla JavaScript.",rights:"Alle rettigheder forbeholdes.",playground:"Eksperimentelt Playground"}},X={en:Le,dk:Ae};function Ee({route:e,t}){return`
  ...
  `}function z(e,t,n,o=""){const r=`nav-link nav-link-${e==="/"?"home":e.slice(1)} ${o}`.trim();return`<a class="${n===e?`${r} active`:r}" href="${e}" data-link>${t}</a>`}function Pe(e){return`
  ...
  `}function Te(e){const t=document.querySelector("#theme-toggle");t&&t.addEventListener("click",e)}function Ie(e){return`
  ...
  `}function Ce(e){const t=document.querySelector("#language-toggle");t&&t.addEventListener("click",e)}function xe({t:e,theme:t,language:n}){const o=new Date().getFullYear();return`
  ...
  `}const Fe="I focus on architecture thinking, frontend systems, and product-minded delivery.",Be="Recent work centers on SPA structure, interaction quality, and maintainable design systems.",Ve="I prioritize separation of concerns, explicit state, and measurable performance.",S={skills:Fe,projects:Be,architecture:Ve,default:"In this phase, I can answer on skills, projects, and architecture approach."},de="https://ask-johan-api.onrender.com".replace(/\/$/,""),ue="johanscv.askJohanAccessCode",Q="Access code is required to use Ask Johan.",Je=42,We=24,Ne=1200,Ke=260,Ue=520,Y={en:["What is your favorite dish?","When is your birthday?","Where do you live in Copenhagen?","What kind of IT architecture do you want to work with?","What is your strongest technical skill right now?","How do you approach system design decisions?","What have you learned from your current student job?","Which projects best represent your profile?","How do you balance UX quality and performance?","How do you work with data quality in practice?","How can we collaborate on a relevant opportunity?"],dk:["Hvad er din yndlingsret?","Hvornår har du fødselsdag?","Hvor bor du i København?","Hvilken type IT-arkitektur vil du arbejde med?","Hvad er din stærkeste tekniske kompetence lige nu?","Hvordan træffer du arkitektur- og designbeslutninger?","Hvad har du lært i dit nuværende studiejob?","Hvilke projekter repræsenterer dig bedst?","Hvordan balancerer du UX-kvalitet og performance?","Hvordan arbejder du med datakvalitet i praksis?","Hvordan kan vi samarbejde om en relevant mulighed?"]};let v=null,q=0;function pe({t:e}){const[t,n]=Ge(e.ask.title);return`
  ...
  `}function Ge(e="Ask Johan"){const t=String(e).trim();if(!t)return["Ask","Johan"];const n=t.split(/\s+/);if(n.length===1)return[n[0],""];const o=n.pop();return[n.join(" "),o]}function me(e="en"){const t=document.querySelector("#ask-input"),n=document.querySelector("#ask-submit"),o=document.querySelector("#ask-answer");if(!t||!n||!o)return;tt(t,e);const i=async()=>{const r=t.value.trim().toLowerCase();n.disabled=!0;try{const a=await Xe(r);await it(o,a)}finally{n.disabled=!1}};n.addEventListener("click",i),t.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}async function Xe(e){if(!e)return S.default;try{return await Qe(e)}catch(t){return console.warn("Ask Johan API failed, falling back to mock answer:",t),Z(e)}return Z(e)}function Z(e){return e.includes("skill")?S.skills:e.includes("project")?S.projects:e.includes("architect")?S.architecture:S.default}function ze(){const e=localStorage.getItem(ue);return e&&e.trim()?e:""}async function Qe(e){if(!de)throw new Error("VITE_API_BASE_URL is not configured.");const t=ze();if(!t)return Q;const n=await Ye(e,t);if(n.status===401)return localStorage.removeItem(ue),Q;if(!n.ok)throw new Error(await et(n));const o=await n.json(),i=Ze(o);if(!i)throw new Error("API returned an empty answer.");return i}function Ye(e,t){const n=new AbortController,o=window.setTimeout(()=>n.abort(),12e3);return fetch(`${de}/api/ask-johan`,{method:"POST",headers:{"Content-Type":"application/json","x-access-code":t},body:JSON.stringify({question:e}),signal:n.signal}).finally(()=>{window.clearTimeout(o)})}function Ze(e){return typeof e?.answer!="string"?"":e.answer.trim()||""}async function et(e){try{const t=await e.json();if(typeof t?.answer=="string"&&t.answer.trim())return`${e.status} ${e.statusText}: ${t.answer.trim()}`}catch{}return`${e.status} ${e.statusText}: API request failed.`}function tt(e,t){ot();const n=nt(Y[t]||Y.en),o=++q;let i=0,r=0,a=!1;const s=()=>{if(o!==q)return;const d=n[i];if(!a){if(r+=1,e.placeholder=d.slice(0,r),r>=d.length){a=!0,v=window.setTimeout(s,Ne);return}v=window.setTimeout(s,Je);return}if(r-=1,e.placeholder=d.slice(0,Math.max(r,0)),r<=0){a=!1,i=(i+1)%n.length,v=window.setTimeout(s,Ke);return}v=window.setTimeout(s,We)};s()}function nt(e){const t=[...e];for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function ot(){v&&(window.clearTimeout(v),v=null),q+=1}async function it(e,t){const n=String(t||""),o=e.offsetHeight;e.style.height=`${o}px`,e.textContent=n,e.classList.toggle("has-content",!!n.trim());const i=n.trim()?e.scrollHeight:0;e.offsetHeight,e.style.height=`${i}px`,await rt(e),e.style.height=n.trim()?"auto":"0px"}function rt(e){return new Promise(t=>{let n=!1;const o=()=>{n||(n=!0,e.removeEventListener("transitionend",i),t())},i=r=>{r.propertyName==="height"&&o()};e.addEventListener("transitionend",i),window.setTimeout(o,Ue+80)})}const ee=[{id:"cv",title:{en:"CV",dk:"CV"},description:{en:"Updated profile and experience summary.",dk:"Opdateret profil og erfaringsoversigt."},url:"/files/johan-niemann-husbjerg-cv.pdf",actionLabel:{en:"Download CV",dk:"Download CV"},actionType:"download",icon:"download"},{id:"linkedin",title:{en:"LinkedIn",dk:"LinkedIn"},description:{en:"Professional profile, education, and work history.",dk:"Professionel profil, uddannelse og arbejdserfaring."},url:"https://www.linkedin.com/in/johan-niemann-h-038906312/",actionLabel:{en:"Go to LinkedIn",dk:"Gå til LinkedIn"},actionType:"external",icon:"linkedin"},{id:"github",title:{en:"GitHub",dk:"GitHub"},description:{en:"Code repositories, projects, and technical work.",dk:"Kode-repositorier, projekter og teknisk arbejde."},url:"https://github.com/johanniemann",actionLabel:{en:"Go to GitHub",dk:"Gå til GitHub"},actionType:"external",icon:"github"},{id:"location",title:{en:"Location",dk:"Lokation"},description:{en:"Where I live in Copenhagen.",dk:"Hvor jeg bor i København."},url:"https://www.google.com/maps/place/Enghavevej+63,+1674+K%C3%B8benhavn/@55.665423,12.5330593,15z/data=!3m1!4b1!4m6!3m5!1s0x4652539dab759293:0xf1e50266a0d1baf1!8m2!3d55.6654113!4d12.5433376!16s%2Fg%2F11nnv8kwnj?entry=ttu&g_ep=EgoyMDI2MDIxMS4wIKXMDSoASAFQAw%3D%3D",actionLabel:{en:"Open in Maps",dk:"Åbn i Maps"},actionType:"external",icon:"location"}];function te(e,t,n=!1){const o=x(e.title,t),i=x(e.description,t),r=at(e.url),a=n?'tabindex="-1"':'tabindex="0"',s=n?"file-card file-card-clone":"file-card",d=st(e,n),l=ct(e.icon),u=x(e.actionLabel,t)||lt(e.actionType,o,t);return`
    <article class="${s}" ${a}>
  ...
  `}function x(e,t){return typeof e=="string"?e:e&&typeof e=="object"&&(e[t]||e.en||Object.values(e)[0])||""}let y=null,b=!1,w=null,P=null;const mt=.018,E={interaction:1200,drag:900,wheel:1100};function ft({t:e,language:t}){const n=ee.map(i=>te(i,t)).join(""),o=ee.map(i=>te(i,t,!0)).join("");return`
  ...
  `}function gt(){const e=document.querySelector("#file-scroller-viewport"),t=document.querySelector("#file-scroller-track");if(!e||!t)return;ht(),O(),b=!0;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let o=!1,i=!1,r=null,a=!1,s=0,d=0,l=0,u=t.scrollWidth/2,k=performance.now();const L=()=>{t.style.transform=`translate3d(${-l}px, 0, 0)`},I=c=>{if(!u)return 0;const f=c%u;return f<0?f+u:f},C=c=>{if(!b||n||o)return;const f=c-k;k=c,l=I(l+f*mt),L(),y=window.requestAnimationFrame(C)},g=()=>{R(),b=!1,O()},h=()=>{R(),!(b||n||o)&&(b=!0,k=performance.now(),y=window.requestAnimationFrame(C))},K=c=>{if(c.target.closest("a, button, input, textarea, select")){g(),w=window.setTimeout(h,E.interaction);return}i=!0,r=c.pointerId,a=!1,s=c.clientX,d=l,g(),e.setPointerCapture(r)},U=c=>{if(!i||c.pointerId!==r)return;const f=c.clientX-s;!a&&Math.abs(f)>6&&(a=!0,o=!0,e.classList.add("is-dragging")),o&&(l=I(d-f),L())},A=c=>{!i||c.pointerId!==r||(i=!1,r=null,o=!1,e.classList.remove("is-dragging"),e.hasPointerCapture(c.pointerId)&&e.releasePointerCapture(c.pointerId),w=window.setTimeout(h,a?E.drag:E.interaction))},G=c=>{g(),l=I(l+c.deltaY*.8+c.deltaX),L(),w=window.setTimeout(h,E.wheel)};e.addEventListener("mouseenter",g),e.addEventListener("mouseleave",h),e.addEventListener("focusin",g),e.addEventListener("focusout",h),e.addEventListener("pointerdown",K),e.addEventListener("pointermove",U),e.addEventListener("pointerup",A),e.addEventListener("pointercancel",A),e.addEventListener("wheel",G,{passive:!0}),P=()=>{e.removeEventListener("mouseenter",g),e.removeEventListener("mouseleave",h),e.removeEventListener("focusin",g),e.removeEventListener("focusout",h),e.removeEventListener("pointerdown",K),e.removeEventListener("pointermove",U),e.removeEventListener("pointerup",A),e.removeEventListener("pointercancel",A),e.removeEventListener("wheel",G)},window.requestAnimationFrame(()=>{u=t.scrollWidth/2,L()}),n||(y=window.requestAnimationFrame(C))}function O(){y&&(window.cancelAnimationFrame(y),y=null)}function R(){w&&(window.clearTimeout(w),w=null)}function ht(){b=!1,P&&(P(),P=null),O(),R()}function vt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="content-section section-reveal" id="projects-preview">
        ...
        <div class="projects-grid projects-grid-compact">
          ${ce.slice(0,2).map(n=>bt(n,t)).join("")}
        </div>
  ...
  `}function kt({language:e}){me(e),gt()}function bt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
    </article>
  `}const yt=Object.freeze(Object.defineProperty({__proto__:null,mount:kt,render:vt},Symbol.toStringTag,{value:"Module"}));function wt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="resume-section section-reveal" id="resume-qualifications">
        ...
        <div class="qual-grid">
          <article class="qual-card">
            ...
            <ul class="qual-list">
              ${n.qualifications.it.map(oe).join("")}
            </ul>
          </article>
          <article class="qual-card">
            <h4 class="qual-title">${e.resume.personalQualities}</h4>
            <ul class="qual-list">
              ${n.qualifications.personal.map(oe).join("")}
            </ul>
          </article>
        </div>
      </section>
  ...
  `}function oe(e){return`<li>${e}</li>`}const It=Object.freeze(Object.defineProperty({__proto__:null,render:At},Symbol.toStringTag,{value:"Module"}));function Ct({t:e}){return`
    <main class="page-stack">
  ...
  `}function xt({t:e}){document.querySelectorAll("[data-copy]").forEach(n=>{n.dataset.defaultLabel=n.querySelector(".file-action-text")?.textContent||"",n.addEventListener("click",async()=>{if(n.dataset.busy==="true")return;const o=n.getAttribute("data-copy")||"";!o||!await Dt(o)||await _t(n,e.contact.copied)})})}function M({label:e,value:t,action:n}){return`
  ...
  `}async function Dt(e){try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();const n=document.execCommand("copy");return document.body.removeChild(t),n}}async function _t(e,t){const n=e.querySelector(".file-action-text");if(!n)return;const o=e.dataset.defaultLabel||n.textContent||"",i=180,r=900;e.dataset.busy="true",e.classList.add("is-label-hidden"),await D(i),n.textContent=t,e.classList.remove("is-label-hidden"),await D(r),e.classList.add("is-label-hidden"),await D(i),n.textContent=o,e.classList.remove("is-label-hidden"),e.dataset.busy="false"}function D(e){return new Promise(t=>{window.setTimeout(t,e)})}const qt=Object.freeze(Object.defineProperty({__proto__:null,mount:xt,render:Ct},Symbol.toStringTag,{value:"Module"}));function Ot({t:e,language:t}){return`
    <main class="page-stack">
  ...
  `}function Rt({language:e}){me(e)}const Ft=Object.freeze(Object.defineProperty({__proto__:null,mount:Rt,render:Ot},Symbol.toStringTag,{value:"Module"}));function Bt(e){return`<div class="page-transition-enter">${e}</div>`}const ie={"/":yt,"/projects":$t,"/resume":It,"/contact":qt,"/playground":Ft},F="/johanscv.dk/",Vt=500,Jt={"/files":"/resume"};function fe(e){const t=e.startsWith("/")?e.slice(1):e;return`${F}${t}`}function re(e=window.location.pathname){if(!e.startsWith(F))return"/";const t=e.slice(F.length-1)||"/";return t.length>1&&t.endsWith("/")?t.slice(0,-1):t}function Wt({mountEl:e,renderFrame:t,pageContext:n,onRouteChange:o}){let i=!1;const r=()=>{const s=re(),d=Jt[s]||s,l=ie[d]||ie["/"],u=n(d);s!==d&&history.replaceState({},"",fe(d)),e.innerHTML=Bt(l.render(u)),l.mount&&l.mount(u),o(d),requestAnimationFrame(()=>{const k=e.querySelector(".page-transition-enter");k&&k.classList.add("is-visible")})},a=()=>{if(i)return;i=!0;const s=e.querySelector(".page-transition-enter");if(!s){r(),i=!1;return}s.classList.remove("is-visible"),s.classList.add("is-exiting"),window.setTimeout(()=>{r(),i=!1},Vt)};return document.addEventListener("click",s=>{const d=s.target.closest("[data-link]");if(!d)return;const l=d.getAttribute("href");!l||!l.startsWith("/")||(s.preventDefault(),l!==re()&&Nt(l,a))}),window.addEventListener("popstate",a),t(r),{refresh:a}}function Nt(e,t){history.pushState({},"",fe(e)),t()}Zt();const Kt=document.querySelector("#app");Kt.innerHTML=`
...
`;const ge="johanscv.askJohanAccessCode",he="johanscv.siteAccessGranted",Ut=500,Gt=.2,_=document.querySelector("#welcome-root"),Xt=document.querySelector("#nav-root"),zt=document.querySelector("#page-root"),Qt=document.querySelector("#footer-root"),ve=document.querySelector("#scroll-hint-root");let B=!1,ae=!1,V=!1,ke=null,se=!1;nn()?be():tn();function be(){V||(V=!0,ke=Wt({mountEl:zt,renderFrame:e=>{e(),en()},pageContext:()=>{const e=m();return{t:j(e.language),language:e.language}},onRouteChange:e=>{N({route:e}),W(e),Yt(),$()}}),ye(),J(),$e(),an(),W(m().route),$())}function ye(){const e=m(),t=j(e.language);Xt.innerHTML=Ee({route:e.route,t}),we()}function J(){const e=m(),t=j(e.language);Qt.innerHTML=xe({t,theme:e.theme,language:e.language}),Te(()=>{on(),J()}),Ce(()=>{rn(),ye(),W(m().route),J(),$e(),$(),ke?.refresh()})}function Yt(){const e=document.querySelectorAll(".section-reveal"),t=new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:Gt});e.forEach((n,o)=>{n.style.transitionDelay=`${Math.min(o*70,240)}ms`,t.observe(n)})}function Zt(){const e=new URL(window.location.href),t=e.searchParams.get("p");if(!t)return;const n=decodeURIComponent(t),[o,i]=n.split("&q="),r=i?`?${decodeURIComponent(i)}`:"",a=`${o}${r}${e.hash}`;window.history.replaceState(null,"",a)}function en(){if(ae)return;ae=!0;let e=window.scrollY,t=!1;const n=()=>{t||(t=!0,window.requestAnimationFrame(()=>{const o=window.scrollY,i=o-e;o<36||i<-8?B=!1:i>8&&(B=!0),e=o,we(),t=!1}))};window.addEventListener("scroll",n,{passive:!0})}function we(){const e=document.querySelector("#navbar");e&&e.classList.toggle("nav-hidden",B)}function W(e){document.querySelectorAll(".nav-link").forEach(n=>{const o=n.getAttribute("href");n.classList.toggle("active",o===e)})}function tn(){const e=m(),t=j(e.language);_.innerHTML=Me({t}),document.body.classList.add("welcome-active");const n=_.querySelector(".welcome-screen");window.requestAnimationFrame(()=>{n?.classList.add("is-visible")}),He(o=>Se(o)?(localStorage.setItem(ge,o),localStorage.setItem(he,"true"),n?.classList.remove("is-visible"),n?.classList.add("is-exiting"),be(),window.setTimeout(()=>{_.innerHTML="",document.body.classList.remove("welcome-active")},Ut),{ok:!0}):{ok:!1,message:t.welcome.passwordError})}function Se(e){const t="family-friends-2026".trim();return e?t?e===t:!0:!1}function nn(){const e=localStorage.getItem(he)==="true",t=localStorage.getItem(ge)?.trim()||"";return e&&Se(t)}function j(e){return X[e]||X.en}function on(){const e=m().theme;N({theme:e==="dark"?"light":"dark"})}function rn(){const e=m().language;N({language:e==="en"?"dk":"en"})}function $e(){const e=m(),t=j(e.language),n=je()?" is-hidden":"";ve.innerHTML=`
  ...
  `}function an(){se||(se=!0,ve.addEventListener("click",e=>{e.target.closest("#scroll-hint")&&window.scrollBy({top:Math.max(window.innerHeight*.92,240),behavior:"smooth"})}),window.addEventListener("scroll",$,{passive:!0}),window.addEventListener("resize",$))}function $(){const e=document.querySelector("#scroll-hint");e&&e.classList.toggle("is-hidden",je())}function je(){const e=document.documentElement,t=Math.max(0,e.scrollHeight-window.innerHeight),n=t>24,o=window.scrollY>=t-28;return!V||!n||o}
