(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const Se={nav:{home:"Home",projects:"Projects",files:"Resume",contact:"Contact"},hero:{name:"Johan Niemann Husbjerg",title:"IT Architecture student shaping precise, human-centered systems."},welcome:{title:"Welcome",intro:"This site is a focused overview of my architecture profile, practical experience, and current projects.",point1:"Explore projects and implementation work.",point2:"Review my full Resume / CV structure.",point3:"Use Ask Johan for quick context.",continue:"Continue",passwordLabel:"Site access code",passwordPlaceholder:"Enter access code",passwordError:"Invalid access code. Please try again."},ask:{title:"Ask Johan",placeholder:"Ask about skills, projects, or architecture...",button:"Answer"},projects:{title:"Projects",intro:"Focused work in architecture, frontend systems, and product execution.",previewTitle:"Selected Work",previewIntro:"A snapshot of practical architecture and frontend execution.",cta:"View all projects"},files:{title:"Resume / CV",intro:"Education, experience, voluntary work, and qualifications."},fileScroller:{title:"Links and files",ariaLabel:"Links and files carousel"},resume:{previewTitle:"Resume Snapshot",previewIntro:"A structured view of my education, practical experience, and key competencies.",cta:"Open Resume / CV",downloadPdf:"Download resume as PDF",education:"Education",experience:"Work Experience",voluntary:"Voluntary Work",qualifications:"Qualifications",itSkills:"Core IT Skills",personalQualities:"Personal Qualities"},contact:{title:"Contact",intro:"Reach out directly by email, phone, or LinkedIn.",emailLabel:"Email",phoneLabel:"Phone",linkedinLabel:"LinkedIn",copyEmail:"Copy E-Mail",copyPhone:"Copy phonenumber",connectLinkedin:"Connect on LinkedIn",copied:"Copied"},scrollHint:{label:"Scroll for more"},footer:{builtWith:"Built with Vite, Tailwind, and Vanilla JavaScript.",rights:"All rights reserved."}},Le={nav:{home:"Hjem",projects:"Projekter",files:"CV",contact:"Kontakt"},hero:{name:"Johan Niemann Husbjerg",title:"IT-arkitekturstuderende med fokus på præcise, menneskelige systemer."},welcome:{title:"Velkommen",intro:"Denne side giver et fokuseret overblik over min arkitekturprofil, praktiske erfaring og nuværende projekter.",point1:"Se projekter og konkret implementeringsarbejde.",point2:"Gennemgå mit fulde Resume / CV.",point3:"Brug Ask Johan for hurtig kontekst.",continue:"Fortsæt",passwordLabel:"Adgangskode til siden",passwordPlaceholder:"Indtast adgangskode",passwordError:"Ugyldig adgangskode. Prøv igen."},ask:{title:"Spørg Johan",placeholder:"Spørg om kompetencer, projekter eller arkitektur...",button:"Svar"},projects:{title:"Projekter",intro:"Fokuseret arbejde inden for arkitektur, frontend-systemer og produktudførelse.",previewTitle:"Udvalgt Arbejde",previewIntro:"Et udsnit af praktisk arkitektur og frontend-udførelse.",cta:"Se alle projekter"},files:{title:"Resume / CV",intro:"Uddannelse, arbejdserfaring, frivilligt arbejde og kvalifikationer."},fileScroller:{title:"Links og filer",ariaLabel:"Karusel med links og filer"},resume:{previewTitle:"CV overblik",previewIntro:"Et struktureret overblik over uddannelse, praktisk erfaring og væsentlige kompetencer.",cta:"Åbn Resume / CV",downloadPdf:"Download resume som PDF",education:"Uddannelse",experience:"Arbejdserfaring",voluntary:"Frivilligt arbejde",qualifications:"Kvalifikationer",itSkills:"Væsentlige IT-kundskaber",personalQualities:"Personlige kvaliteter"},contact:{title:"Kontakt",intro:"Kontakt mig direkte via e-mail, telefon eller LinkedIn.",emailLabel:"E-mail",phoneLabel:"Telefon",linkedinLabel:"LinkedIn",copyEmail:"Kopiér e-mail",copyPhone:"Kopiér telefonnummer",connectLinkedin:"Forbind på LinkedIn",copied:"Kopieret"},scrollHint:{label:"Scroll for mere"},footer:{builtWith:"Bygget med Vite, Tailwind og Vanilla JavaScript.",rights:"Alle rettigheder forbeholdes."}},X={en:Se,dk:Le};function $e({route:e,t}){return`
  ...
  `}function Q(e,t,n,o=""){const r=`nav-link nav-link-${e==="/"?"home":e.slice(1)} ${o}`.trim();return`<a class="${n===e?`${r} active`:r}" href="${e}" data-link>${t}</a>`}function je(e){return`
  ...
  `}function Ae(e){const t=document.querySelector("#theme-toggle");t&&t.addEventListener("click",e)}function Ee(e){return`
  ...
  `}function Pe(e){const t=document.querySelector("#language-toggle");t&&t.addEventListener("click",e)}function Ie({t:e,theme:t,language:n}){const o=new Date().getFullYear();return`
  ...
  `}const _e="I focus on architecture thinking, frontend systems, and product-minded delivery.",Re="Recent work centers on SPA structure, interaction quality, and maintainable design systems.",Oe="I prioritize separation of concerns, explicit state, and measurable performance.",S={skills:_e,projects:Re,architecture:Oe,default:"Great question. In this phase, I can answer on skills, projects, and architecture approach."},ce="http://127.0.0.1:8787".replace(/\/$/,""),de="johanscv.askJohanAccessCode",Y="Access code is required to use Ask Johan.",Fe=42,Ve=24,Be=1200,Je=260,We=520,z={en:["What is your favorite dish?","When is your birthday?","Where do you live in Copenhagen?","What kind of IT architecture do you want to work with?","What is your strongest technical skill right now?","How do you approach system design decisions?","What have you learned from your current student job?","Which projects best represent your profile?","How do you balance UX quality and performance?","How do you work with data quality in practice?","How can we collaborate on a relevant opportunity?"],dk:["Hvad er din yndlingsret?","Hvornår har du fødselsdag?","Hvor bor du i København?","Hvilken type IT-arkitektur vil du arbejde med?","Hvad er din stærkeste tekniske kompetence lige nu?","Hvordan træffer du arkitektur- og designbeslutninger?","Hvad har du lært i dit nuværende studiejob?","Hvilke projekter repræsenterer dig bedst?","Hvordan balancerer du UX-kvalitet og performance?","Hvordan arbejder du med datakvalitet i praksis?","Hvordan kan vi samarbejde om en relevant mulighed?"]};let v=null,_=0;function Ne({t:e}){const[t,n]=Ke(e.ask.title);return`
  ...
  `}function x(e,t){return typeof e=="string"?e:e&&typeof e=="object"&&(e[t]||e.en||Object.values(e)[0])||""}let w=null,b=!1,y=null,P=null;const ft=.018,E={interaction:1200,drag:900,wheel:1100};function gt({t:e,language:t}){const n=Z.map(i=>ee(i,t)).join(""),o=Z.map(i=>ee(i,t,!0)).join("");return`
  ...
  `}function ht(){const e=document.querySelector("#file-scroller-viewport"),t=document.querySelector("#file-scroller-track");if(!e||!t)return;vt(),R(),b=!0;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let o=!1,i=!1,r=null,a=!1,s=0,d=0,l=0,u=t.scrollWidth/2,k=performance.now();const j=()=>{t.style.transform=`translate3d(${-l}px, 0, 0)`},T=c=>{if(!u)return 0;const f=c%u;return f<0?f+u:f},C=c=>{if(!b||n||o)return;const f=c-k;k=c,l=T(l+f*ft),j(),w=window.requestAnimationFrame(C)},g=()=>{O(),b=!1,R()},h=()=>{O(),!(b||n||o)&&(b=!0,k=performance.now(),w=window.requestAnimationFrame(C))},K=c=>{if(c.target.closest("a, button, input, textarea, select")){g(),y=window.setTimeout(h,E.interaction);return}i=!0,r=c.pointerId,a=!1,s=c.clientX,d=l,g(),e.setPointerCapture(r)},G=c=>{if(!i||c.pointerId!==r)return;const f=c.clientX-s;!a&&Math.abs(f)>6&&(a=!0,o=!0,e.classList.add("is-dragging")),o&&(l=T(d-f),j())},A=c=>{!i||c.pointerId!==r||(i=!1,r=null,o=!1,e.classList.remove("is-dragging"),e.hasPointerCapture(c.pointerId)&&e.releasePointerCapture(c.pointerId),y=window.setTimeout(h,a?E.drag:E.interaction))},U=c=>{g(),l=T(l+c.deltaY*.8+c.deltaX),j(),y=window.setTimeout(h,E.wheel)};e.addEventListener("mouseenter",g),e.addEventListener("mouseleave",h),e.addEventListener("focusin",g),e.addEventListener("focusout",h),e.addEventListener("pointerdown",K),e.addEventListener("pointermove",G),e.addEventListener("pointerup",A),e.addEventListener("pointercancel",A),e.addEventListener("wheel",U,{passive:!0}),P=()=>{e.removeEventListener("mouseenter",g),e.removeEventListener("mouseleave",h),e.removeEventListener("focusin",g),e.removeEventListener("focusout",h),e.removeEventListener("pointerdown",K),e.removeEventListener("pointermove",G),e.removeEventListener("pointerup",A),e.removeEventListener("pointercancel",A),e.removeEventListener("wheel",U)},window.requestAnimationFrame(()=>{u=t.scrollWidth/2,j()}),n||(w=window.requestAnimationFrame(C))}function R(){w&&(window.cancelAnimationFrame(w),w=null)}function O(){y&&(window.clearTimeout(y),y=null)}function vt(){b=!1,P&&(P(),P=null),R(),O()}function kt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="content-section section-reveal" id="projects-preview">
        ...
        <div class="projects-grid projects-grid-compact">
          ${le.slice(0,2).map(n=>wt(n,t)).join("")}
        </div>
  ...
  `}function bt({language:e}){Ge(e),ht()}function wt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
    </article>
  `}const yt=Object.freeze(Object.defineProperty({__proto__:null,mount:bt,render:kt},Symbol.toStringTag,{value:"Module"}));function St({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="projects-grid section-reveal" aria-label="${e.projects.title}">
        ${le.map(n=>Lt(n,t)).join("")}
      </section>
    </main>
  `}function Lt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
  ...
  `}async function Dt(e){try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();const n=document.execCommand("copy");return document.body.removeChild(t),n}}async function _t(e,t){const n=e.querySelector(".file-action-text");if(!n)return;const o=e.dataset.defaultLabel||n.textContent||"",i=180,r=900;e.dataset.busy="true",e.classList.add("is-label-hidden"),await q(i),n.textContent=t,e.classList.remove("is-label-hidden"),await q(r),e.classList.add("is-label-hidden"),await q(i),n.textContent=o,e.classList.remove("is-label-hidden"),e.dataset.busy="false"}function q(e){return new Promise(t=>{window.setTimeout(t,e)})}const Rt=Object.freeze(Object.defineProperty({__proto__:null,mount:Mt,render:xt},Symbol.toStringTag,{value:"Module"}));function Ot(e){return`<div class="page-transition-enter">${e}</div>`}const oe={"/":yt,"/projects":$t,"/resume":Ct,"/contact":Rt},F="/johanscv.dk/",Ft=500,Vt={"/files":"/resume"};function ue(e){const t=e.startsWith("/")?e.slice(1):e;return`${F}${t}`}function ie(e=window.location.pathname){if(!e.startsWith(F))return"/";const t=e.slice(F.length-1)||"/";return t.length>1&&t.endsWith("/")?t.slice(0,-1):t}function Bt({mountEl:e,renderFrame:t,pageContext:n,onRouteChange:o}){let i=!1;const r=()=>{const s=ie(),d=Vt[s]||s,l=oe[d]||oe["/"],u=n(d);s!==d&&history.replaceState({},"",ue(d)),e.innerHTML=Ot(l.render(u)),l.mount&&l.mount(u),o(d),requestAnimationFrame(()=>{const k=e.querySelector(".page-transition-enter");k&&k.classList.add("is-visible")})},a=()=>{if(i)return;i=!0;const s=e.querySelector(".page-transition-enter");if(!s){r(),i=!1;return}s.classList.remove("is-visible"),s.classList.add("is-exiting"),window.setTimeout(()=>{r(),i=!1},Ft)};return document.addEventListener("click",s=>{const d=s.target.closest("[data-link]");if(!d)return;const l=d.getAttribute("href");!l||!l.startsWith("/")||(s.preventDefault(),l!==ie()&&Jt(l,a))}),window.addEventListener("popstate",a),t(r),{refresh:a}}function Jt(e,t){history.pushState({},"",ue(e)),t()}Yt();const Wt=document.querySelector("#app");Wt.innerHTML=`
...
`;const pe="johanscv.askJohanAccessCode",me="johanscv.siteAccessGranted",Nt=500,Kt=.2,D=document.querySelector("#welcome-root"),Gt=document.querySelector("#nav-root"),Ut=document.querySelector("#page-root"),Xt=document.querySelector("#footer-root"),fe=document.querySelector("#scroll-hint-root");let V=!1,re=!1,B=!1,ge=null,ae=!1;en()?he():Zt();function he(){B||(B=!0,ge=Bt({mountEl:Ut,renderFrame:e=>{e(),zt()},pageContext:()=>{const e=m();return{t:$(e.language),language:e.language}},onRouteChange:e=>{N({route:e}),W(e),Qt(),L()}}),ve(),J(),we(),on(),W(m().route),L())}function ve(){const e=m(),t=$(e.language);Gt.innerHTML=$e({route:e.route,t}),ke()}function J(){const e=m(),t=$(e.language);Xt.innerHTML=Ie({t,theme:e.theme,language:e.language}),Ae(()=>{tn(),J()}),Pe(()=>{nn(),ve(),W(m().route),J(),we(),L(),ge?.refresh()})}function Qt(){const e=document.querySelectorAll(".section-reveal"),t=new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:Kt});e.forEach((n,o)=>{n.style.transitionDelay=`${Math.min(o*70,240)}ms`,t.observe(n)})}function Yt(){const e=new URL(window.location.href),t=e.searchParams.get("p");if(!t)return;const n=decodeURIComponent(t),[o,i]=n.split("&q="),r=i?`?${decodeURIComponent(i)}`:"",a=`${o}${r}${e.hash}`;window.history.replaceState(null,"",a)}function zt(){if(re)return;re=!0;let e=window.scrollY,t=!1;const n=()=>{t||(t=!0,window.requestAnimationFrame(()=>{const o=window.scrollY,i=o-e;o<36||i<-8?V=!1:i>8&&(V=!0),e=o,ke(),t=!1}))};window.addEventListener("scroll",n,{passive:!0})}function ke(){const e=document.querySelector("#navbar");e&&e.classList.toggle("nav-hidden",V)}function W(e){document.querySelectorAll(".nav-link").forEach(n=>{const o=n.getAttribute("href");n.classList.toggle("active",o===e)})}function Zt(){const e=m(),t=$(e.language);D.innerHTML=Te({t}),document.body.classList.add("welcome-active");const n=D.querySelector(".welcome-screen");window.requestAnimationFrame(()=>{n?.classList.add("is-visible")}),Ce(o=>be(o)?(localStorage.setItem(pe,o),localStorage.setItem(me,"true"),n?.classList.remove("is-visible"),n?.classList.add("is-exiting"),he(),window.setTimeout(()=>{D.innerHTML="",document.body.classList.remove("welcome-active")},Nt),{ok:!0}):{ok:!1,message:t.welcome.passwordError})}function be(e){const t="".trim();return e?t?e===t:!0:!1}function en(){const e=localStorage.getItem(me)==="true",t=localStorage.getItem(pe)?.trim()||"";return e&&be(t)}function $(e){return X[e]||X.en}function tn(){const e=m().theme;N({theme:e==="dark"?"light":"dark"})}function nn(){const e=m().language;N({language:e==="en"?"dk":"en"})}function we(){const e=m(),t=$(e.language),n=ye()?" is-hidden":"";fe.innerHTML=`
  ...
  `}function on(){ae||(ae=!0,fe.addEventListener("click",e=>{e.target.closest("#scroll-hint")&&window.scrollBy({top:Math.max(window.innerHeight*.92,240),behavior:"smooth"})}),window.addEventListener("scroll",L,{passive:!0}),window.addEventListener("resize",L))}function L(){const e=document.querySelector("#scroll-hint");e&&e.classList.toggle("is-hidden",ye())}function ye(){const e=document.documentElement,t=Math.max(0,e.scrollHeight-window.innerHeight),n=t>24,o=window.scrollY>=t-28;return!B||!n||o}
