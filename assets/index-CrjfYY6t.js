(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();const ye={nav:{home:"Home",projects:"Projects",files:"Resume",contact:"Contact"},hero:{name:"Johan Niemann Husbjerg",title:"IT Architecture student shaping precise, human-centered systems."},welcome:{title:"Welcome",intro:"This site is a focused overview of my architecture profile, practical experience, and current projects.",point1:"Explore projects and implementation work.",point2:"Review my full Resume / CV structure.",point3:"Use Ask Johan for quick context.",continue:"Continue",passwordLabel:"Site access code",passwordPlaceholder:"Enter access code",passwordError:"Invalid access code. Please try again."},ask:{title:"Ask Johan",placeholder:"Ask about skills, projects, or architecture...",button:"Answer"},projects:{title:"Projects",intro:"Focused work in architecture, frontend systems, and product execution.",previewTitle:"Selected Work",previewIntro:"A snapshot of practical architecture and frontend execution.",cta:"View all projects"},files:{title:"Resume / CV",intro:"Education, experience, voluntary work, and qualifications."},fileScroller:{title:"Links and files",ariaLabel:"Links and files carousel"},resume:{previewTitle:"Resume Snapshot",previewIntro:"A structured view of my education, practical experience, and key competencies.",cta:"Open Resume / CV",downloadPdf:"Download resume as PDF",education:"Education",experience:"Work Experience",voluntary:"Voluntary Work",qualifications:"Qualifications",itSkills:"Core IT Skills",personalQualities:"Personal Qualities"},contact:{title:"Contact",intro:"Reach out directly by email, phone, or LinkedIn.",emailLabel:"Email",phoneLabel:"Phone",linkedinLabel:"LinkedIn",copyEmail:"Copy E-Mail",copyPhone:"Copy phonenumber",connectLinkedin:"Connect on LinkedIn",copied:"Copied"},scrollHint:{label:"Scroll for more"},footer:{builtWith:"Built with Vite, Tailwind, and Vanilla JavaScript.",rights:"All rights reserved."}},Se={nav:{home:"Hjem",projects:"Projekter",files:"CV",contact:"Kontakt"},hero:{name:"Johan Niemann Husbjerg",title:"IT-arkitekturstuderende med fokus på præcise, menneskelige systemer."},welcome:{title:"Velkommen",intro:"Denne side giver et fokuseret overblik over min arkitekturprofil, praktiske erfaring og nuværende projekter.",point1:"Se projekter og konkret implementeringsarbejde.",point2:"Gennemgå mit fulde Resume / CV.",point3:"Brug Ask Johan for hurtig kontekst.",continue:"Fortsæt",passwordLabel:"Adgangskode til siden",passwordPlaceholder:"Indtast adgangskode",passwordError:"Ugyldig adgangskode. Prøv igen."},ask:{title:"Spørg Johan",placeholder:"Spørg om kompetencer, projekter eller arkitektur...",button:"Svar"},projects:{title:"Projekter",intro:"Fokuseret arbejde inden for arkitektur, frontend-systemer og produktudførelse.",previewTitle:"Udvalgt Arbejde",previewIntro:"Et udsnit af praktisk arkitektur og frontend-udførelse.",cta:"Se alle projekter"},files:{title:"Resume / CV",intro:"Uddannelse, arbejdserfaring, frivilligt arbejde og kvalifikationer."},fileScroller:{title:"Links og filer",ariaLabel:"Karusel med links og filer"},resume:{previewTitle:"CV overblik",previewIntro:"Et struktureret overblik over uddannelse, praktisk erfaring og væsentlige kompetencer.",cta:"Åbn Resume / CV",downloadPdf:"Download resume som PDF",education:"Uddannelse",experience:"Arbejdserfaring",voluntary:"Frivilligt arbejde",qualifications:"Kvalifikationer",itSkills:"Væsentlige IT-kundskaber",personalQualities:"Personlige kvaliteter"},contact:{title:"Kontakt",intro:"Kontakt mig direkte via e-mail, telefon eller LinkedIn.",emailLabel:"E-mail",phoneLabel:"Telefon",linkedinLabel:"LinkedIn",copyEmail:"Kopiér e-mail",copyPhone:"Kopiér telefonnummer",connectLinkedin:"Forbind på LinkedIn",copied:"Kopieret"},scrollHint:{label:"Scroll for mere"},footer:{builtWith:"Bygget med Vite, Tailwind og Vanilla JavaScript.",rights:"Alle rettigheder forbeholdes."}},X={en:ye,dk:Se};function Le({route:e,t}){return`
  ...
  `}function je(e){const t=document.querySelector("#theme-toggle");t&&t.addEventListener("click",e)}function Ae(e){return`
  ...
  `}function Ee(e){const t=document.querySelector("#language-toggle");t&&t.addEventListener("click",e)}function Pe({t:e,theme:t,language:n}){const o=new Date().getFullYear();return`
  ...
  `}const De="I focus on architecture thinking, frontend systems, and product-minded delivery.",_e="Recent work centers on SPA structure, interaction quality, and maintainable design systems.",Re="I prioritize separation of concerns, explicit state, and measurable performance.",S={skills:De,projects:_e,architecture:Re,default:"Great question. In this phase, I can answer on skills, projects, and architecture approach."},ce="http://127.0.0.1:8787".replace(/\/$/,""),de="johanscv.askJohanAccessCode",Y="Access code is required to use Ask Johan.",Oe=42,Fe=24,Ve=1200,Be=260,Je=520,z={en:["What is your favorite dish?","When is your birthday?","Where do you live in Copenhagen?","What kind of IT architecture do you want to work with?","What is your strongest technical skill right now?","How do you approach system design decisions?","What have you learned from your current student job?","Which projects best represent your profile?","How do you balance UX quality and performance?","How do you work with data quality in practice?","How can we collaborate on a relevant opportunity?"],dk:["Hvad er din yndlingsret?","Hvornår har du fødselsdag?","Hvor bor du i København?","Hvilken type IT-arkitektur vil du arbejde med?","Hvad er din stærkeste tekniske kompetence lige nu?","Hvordan træffer du arkitektur- og designbeslutninger?","Hvad har du lært i dit nuværende studiejob?","Hvilke projekter repræsenterer dig bedst?","Hvordan balancerer du UX-kvalitet og performance?","Hvordan arbejder du med datakvalitet i praksis?","Hvordan kan vi samarbejde om en relevant mulighed?"]};let v=null,_=0;function We({t:e}){const[t,n]=Ne(e.ask.title);return`
  ...
  `}function Ne(e="Ask Johan"){const t=String(e).trim();if(!t)return["Ask","Johan"];const n=t.split(/\s+/);if(n.length===1)return[n[0],""];const o=n.pop();return[n.join(" "),o]}function Ke(e="en"){const t=document.querySelector("#ask-input"),n=document.querySelector("#ask-submit"),o=document.querySelector("#ask-answer");if(!t||!n||!o)return;tt(t,e);const i=async()=>{const r=t.value.trim().toLowerCase();n.disabled=!0;try{const a=await Ge(r);await it(o,a)}finally{n.disabled=!1}};n.addEventListener("click",i),t.addEventListener("keydown",r=>{r.key==="Enter"&&i()})}async function Ge(e){if(!e)return S.default;try{return await Qe(e)}catch(t){return et(t)}return Ue(e)}function Ue(e){return e.includes("skill")?S.skills:e.includes("project")?S.projects:e.includes("architect")?S.architecture:S.default}function Xe(){const e=localStorage.getItem(de);return e&&e.trim()?e:""}async function Qe(e){if(!ce)throw new Error("VITE_API_BASE_URL is not configured.");const t=Xe();if(!t)return Y;const n=await Ye(e,t);if(n.status===401)return localStorage.removeItem(de),Y;if(!n.ok)throw new Error(await Ze(n));const o=await n.json(),i=ze(o);if(!i)throw new Error("API returned an empty answer.");return i}function Ye(e,t){return fetch(`${ce}/api/ask-johan`,{method:"POST",headers:{"Content-Type":"application/json","x-access-code":t},body:JSON.stringify({question:e})})}function ze(e){return typeof e?.answer!="string"?"":e.answer.trim()||""}async function Ze(e){try{const t=await e.json();if(typeof t?.answer=="string"&&t.answer.trim())return`${e.status} ${e.statusText}: ${t.answer.trim()}`}catch{}return`${e.status} ${e.statusText}: API request failed.`}function et(e){return`Ask Johan API error: ${e instanceof Error?e.message:String(e)}`}function tt(e,t){ot();const n=nt(z[t]||z.en),o=++_;let i=0,r=0,a=!1;const s=()=>{if(o!==_)return;const d=n[i];if(!a){if(r+=1,e.placeholder=d.slice(0,r),r>=d.length){a=!0,v=window.setTimeout(s,Ve);return}v=window.setTimeout(s,Oe);return}if(r-=1,e.placeholder=d.slice(0,Math.max(r,0)),r<=0){a=!1,i=(i+1)%n.length,v=window.setTimeout(s,Be);return}v=window.setTimeout(s,Fe)};s()}function nt(e){const t=[...e];for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function ot(){v&&(window.clearTimeout(v),v=null),_+=1}async function it(e,t){const n=String(t||""),o=e.offsetHeight;e.style.height=`${o}px`,e.textContent=n,e.classList.toggle("has-content",!!n.trim());const i=n.trim()?e.scrollHeight:0;e.offsetHeight,e.style.height=`${i}px`,await rt(e),e.style.height=n.trim()?"auto":"0px"}function rt(e){return new Promise(t=>{let n=!1;const o=()=>{n||(n=!0,e.removeEventListener("transitionend",i),t())},i=r=>{r.propertyName==="height"&&o()};e.addEventListener("transitionend",i),window.setTimeout(o,Je+80)})}const Z=[{id:"cv",title:{en:"CV",dk:"CV"},description:{en:"Updated profile and experience summary.",dk:"Opdateret profil og erfaringsoversigt."},url:"/files/johan-niemann-husbjerg-cv.pdf",actionLabel:{en:"Download CV",dk:"Download CV"},actionType:"download",icon:"download"},{id:"linkedin",title:{en:"LinkedIn",dk:"LinkedIn"},description:{en:"Professional profile, education, and work history.",dk:"Professionel profil, uddannelse og arbejdserfaring."},url:"https://www.linkedin.com/in/johan-niemann-h-038906312/",actionLabel:{en:"Go to LinkedIn",dk:"Gå til LinkedIn"},actionType:"external",icon:"linkedin"},{id:"github",title:{en:"GitHub",dk:"GitHub"},description:{en:"Code repositories, projects, and technical work.",dk:"Kode-repositorier, projekter og teknisk arbejde."},url:"https://github.com/johanniemann",actionLabel:{en:"Go to GitHub",dk:"Gå til GitHub"},actionType:"external",icon:"github"},{id:"location",title:{en:"Location",dk:"Lokation"},description:{en:"Where I live in Copenhagen.",dk:"Hvor jeg bor i København."},url:"https://www.google.com/maps/place/Enghavevej+63,+1674+K%C3%B8benhavn/@55.665423,12.5330593,15z/data=!3m1!4b1!4m6!3m5!1s0x4652539dab759293:0xf1e50266a0d1baf1!8m2!3d55.6654113!4d12.5433376!16s%2Fg%2F11nnv8kwnj?entry=ttu&g_ep=EgoyMDI2MDIxMS4wIKXMDSoASAFQAw%3D%3D",actionLabel:{en:"Open in Maps",dk:"Åbn i Maps"},actionType:"external",icon:"location"}];function ee(e,t,n=!1){const o=x(e.title,t),i=x(e.description,t),r=at(e.url),a=n?'tabindex="-1"':'tabindex="0"',s=n?"file-card file-card-clone":"file-card",d=st(e,n),l=ct(e.icon),u=x(e.actionLabel,t)||lt(e.actionType,o,t);return`
    <article class="${s}" ${a}>
  ...
  `}function at(e){return e.startsWith("/")?`/johanscv.dk/${e.slice(1)}`:e}function st(e,t){const n=[];return e.actionType==="download"?n.push("download"):n.push('target="_blank"','rel="noopener noreferrer"'),t&&n.push('tabindex="-1"'),n.join(" ")}function lt(e,t,n){return e==="download"?`Download ${t}`:n==="dk"?`Gå til ${t}`:`Open ${t}`}function ct(e){return e==="linkedin"?"in":e==="github"?dt():e==="location"?ut():pt()}function dt(){return`
  ...
  `}function x(e,t){return typeof e=="string"?e:e&&typeof e=="object"&&(e[t]||e.en||Object.values(e)[0])||""}let w=null,b=!1,y=null,E=null;const mt=.018,A={interaction:1200,drag:900,wheel:1100};function ft({t:e,language:t}){const n=Z.map(i=>ee(i,t)).join(""),o=Z.map(i=>ee(i,t,!0)).join("");return`
  ...
  `}function gt(){const e=document.querySelector("#file-scroller-viewport"),t=document.querySelector("#file-scroller-track");if(!e||!t)return;ht(),R(),b=!0;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let o=!1,i=!1,r=null,a=!1,s=0,d=0,l=0,u=t.scrollWidth/2,k=performance.now();const $=()=>{t.style.transform=`translate3d(${-l}px, 0, 0)`},T=c=>{if(!u)return 0;const f=c%u;return f<0?f+u:f},C=c=>{if(!b||n||o)return;const f=c-k;k=c,l=T(l+f*mt),$(),w=window.requestAnimationFrame(C)},g=()=>{O(),b=!1,R()},h=()=>{O(),!(b||n||o)&&(b=!0,k=performance.now(),w=window.requestAnimationFrame(C))},K=c=>{if(c.target.closest("a, button, input, textarea, select")){g(),y=window.setTimeout(h,A.interaction);return}i=!0,r=c.pointerId,a=!1,s=c.clientX,d=l,g(),e.setPointerCapture(r)},G=c=>{if(!i||c.pointerId!==r)return;const f=c.clientX-s;!a&&Math.abs(f)>6&&(a=!0,o=!0,e.classList.add("is-dragging")),o&&(l=T(d-f),$())},j=c=>{!i||c.pointerId!==r||(i=!1,r=null,o=!1,e.classList.remove("is-dragging"),e.hasPointerCapture(c.pointerId)&&e.releasePointerCapture(c.pointerId),y=window.setTimeout(h,a?A.drag:A.interaction))},U=c=>{g(),l=T(l+c.deltaY*.8+c.deltaX),$(),y=window.setTimeout(h,A.wheel)};e.addEventListener("mouseenter",g),e.addEventListener("mouseleave",h),e.addEventListener("focusin",g),e.addEventListener("focusout",h),e.addEventListener("pointerdown",K),e.addEventListener("pointermove",G),e.addEventListener("pointerup",j),e.addEventListener("pointercancel",j),e.addEventListener("wheel",U,{passive:!0}),E=()=>{e.removeEventListener("mouseenter",g),e.removeEventListener("mouseleave",h),e.removeEventListener("focusin",g),e.removeEventListener("focusout",h),e.removeEventListener("pointerdown",K),e.removeEventListener("pointermove",G),e.removeEventListener("pointerup",j),e.removeEventListener("pointercancel",j),e.removeEventListener("wheel",U)},window.requestAnimationFrame(()=>{u=t.scrollWidth/2,$()}),n||(w=window.requestAnimationFrame(C))}function R(){w&&(window.cancelAnimationFrame(w),w=null)}function O(){y&&(window.clearTimeout(y),y=null)}function ht(){b=!1,E&&(E(),E=null),R(),O()}function vt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="content-section section-reveal" id="projects-preview">
        ...
        <div class="projects-grid projects-grid-compact">
          ${le.slice(0,2).map(n=>bt(n,t)).join("")}
        </div>
  ...
  `}function kt({language:e}){Ke(e),gt()}function bt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
    </article>
  `}const wt=Object.freeze(Object.defineProperty({__proto__:null,mount:kt,render:vt},Symbol.toStringTag,{value:"Module"}));function yt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="projects-grid section-reveal" aria-label="${e.projects.title}">
        ${le.map(n=>St(n,t)).join("")}
      </section>
    </main>
  `}function St(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
  ...
  `}function ne(e){return`<li>${e}</li>`}const Tt=Object.freeze(Object.defineProperty({__proto__:null,render:At},Symbol.toStringTag,{value:"Module"}));function Ct({t:e}){return`
    <main class="page-stack">
      ...
      <section class="contact-stack section-reveal" aria-label="${e.contact.title}">
        ${M({label:e.contact.emailLabel,value:"johan.niemann.husbjerg@gmail.com",action:H({type:"button",icon:Mt(),text:e.contact.copyEmail,attrs:'data-copy="johan.niemann.husbjerg@gmail.com"'})})}
        ${M({label:e.contact.phoneLabel,value:"+45 60 47 42 36",action:H({type:"button",icon:Ht(),text:e.contact.copyPhone,attrs:'data-copy="+45 60 47 42 36"'})})}
  ...
  `}function xt({t:e}){document.querySelectorAll("[data-copy]").forEach(n=>{n.dataset.defaultLabel=n.querySelector(".file-action-text")?.textContent||"",n.addEventListener("click",async()=>{if(n.dataset.busy==="true")return;const o=n.getAttribute("data-copy")||"";!o||!await qt(o)||await Dt(n,e.contact.copied)})})}function M({label:e,value:t,action:n}){return`
  ...
  `}async function qt(e){try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();const n=document.execCommand("copy");return document.body.removeChild(t),n}}async function Dt(e,t){const n=e.querySelector(".file-action-text");if(!n)return;const o=e.dataset.defaultLabel||n.textContent||"",i=180,r=900;e.dataset.busy="true",e.classList.add("is-label-hidden"),await q(i),n.textContent=t,e.classList.remove("is-label-hidden"),await q(r),e.classList.add("is-label-hidden"),await q(i),n.textContent=o,e.classList.remove("is-label-hidden"),e.dataset.busy="false"}function q(e){return new Promise(t=>{window.setTimeout(t,e)})}const _t=Object.freeze(Object.defineProperty({__proto__:null,mount:xt,render:Ct},Symbol.toStringTag,{value:"Module"}));function Rt(e){return`<div class="page-transition-enter">${e}</div>`}const oe={"/":wt,"/projects":Lt,"/resume":Tt,"/contact":_t},F="/johanscv.dk/",Ot=500,Ft={"/files":"/resume"};function ue(e){const t=e.startsWith("/")?e.slice(1):e;return`${F}${t}`}function ie(e=window.location.pathname){if(!e.startsWith(F))return"/";const t=e.slice(F.length-1)||"/";return t.length>1&&t.endsWith("/")?t.slice(0,-1):t}function Vt({mountEl:e,renderFrame:t,pageContext:n,onRouteChange:o}){let i=!1;const r=()=>{const s=ie(),d=Ft[s]||s,l=oe[d]||oe["/"],u=n(d);s!==d&&history.replaceState({},"",ue(d)),e.innerHTML=Rt(l.render(u)),l.mount&&l.mount(u),o(d),requestAnimationFrame(()=>{const k=e.querySelector(".page-transition-enter");k&&k.classList.add("is-visible")})},a=()=>{if(i)return;i=!0;const s=e.querySelector(".page-transition-enter");if(!s){r(),i=!1;return}s.classList.remove("is-visible"),s.classList.add("is-exiting"),window.setTimeout(()=>{r(),i=!1},Ot)};return document.addEventListener("click",s=>{const d=s.target.closest("[data-link]");if(!d)return;const l=d.getAttribute("href");!l||!l.startsWith("/")||(s.preventDefault(),l!==ie()&&Bt(l,a))}),window.addEventListener("popstate",a),t(r),{refresh:a}}function Bt(e,t){history.pushState({},"",ue(e)),t()}Qt();const Jt=document.querySelector("#app");Jt.innerHTML=`
...
`;const pe="johanscv.askJohanAccessCode",me="johanscv.siteAccessGranted",Wt=500,Nt=.2,D=document.querySelector("#welcome-root"),Kt=document.querySelector("#nav-root"),Gt=document.querySelector("#page-root"),Ut=document.querySelector("#footer-root"),fe=document.querySelector("#scroll-hint-root");let V=!1,re=!1,B=!1,ge=null,ae=!1;Zt()?he():zt();function he(){B||(B=!0,ge=Vt({mountEl:Gt,renderFrame:e=>{e(),Yt()},pageContext:()=>{const e=m();return{t:L(e.language),language:e.language}},onRouteChange:e=>{N({route:e}),W(e),Xt(),I()}}),ve(),J(),we(),nn(),W(m().route),I())}function ve(){const e=m(),t=L(e.language);Kt.innerHTML=Le({route:e.route,t}),ke()}function J(){const e=m(),t=L(e.language);Ut.innerHTML=Pe({t,theme:e.theme,language:e.language}),je(()=>{en(),J()}),Ee(()=>{tn(),ve(),W(m().route),J(),we(),ge?.refresh()})}function Xt(){const e=document.querySelectorAll(".section-reveal"),t=new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:Nt});e.forEach((n,o)=>{n.style.transitionDelay=`${Math.min(o*70,240)}ms`,t.observe(n)})}function Qt(){const e=new URL(window.location.href),t=e.searchParams.get("p");if(!t)return;const n=decodeURIComponent(t),[o,i]=n.split("&q="),r=i?`?${decodeURIComponent(i)}`:"",a=`${o}${r}${e.hash}`;window.history.replaceState(null,"",a)}function Yt(){if(re)return;re=!0;let e=window.scrollY,t=!1;const n=()=>{t||(t=!0,window.requestAnimationFrame(()=>{const o=window.scrollY,i=o-e;o<36||i<-8?V=!1:i>8&&(V=!0),e=o,ke(),t=!1}))};window.addEventListener("scroll",n,{passive:!0})}function ke(){const e=document.querySelector("#navbar");e&&e.classList.toggle("nav-hidden",V)}function W(e){document.querySelectorAll(".nav-link").forEach(n=>{const o=n.getAttribute("href");n.classList.toggle("active",o===e)})}function zt(){const e=m(),t=L(e.language);D.innerHTML=Ie({t}),document.body.classList.add("welcome-active");const n=D.querySelector(".welcome-screen");window.requestAnimationFrame(()=>{n?.classList.add("is-visible")}),Te(o=>be(o)?(localStorage.setItem(pe,o),localStorage.setItem(me,"true"),n?.classList.remove("is-visible"),n?.classList.add("is-exiting"),he(),window.setTimeout(()=>{D.innerHTML="",document.body.classList.remove("welcome-active")},Wt),{ok:!0}):{ok:!1,message:t.welcome.passwordError})}function be(e){const t="".trim();return e?t?e===t:!0:!1}function Zt(){const e=localStorage.getItem(me)==="true",t=localStorage.getItem(pe)?.trim()||"";return e&&be(t)}function L(e){return X[e]||X.en}function en(){const e=m().theme;N({theme:e==="dark"?"light":"dark"})}function tn(){const e=m().language;N({language:e==="en"?"dk":"en"})}function we(){const e=m(),t=L(e.language);fe.innerHTML=`
    <button id="scroll-hint" class="scroll-hint" type="button" aria-label="${t.scrollHint.label}">
  ...
  `}function nn(){ae||(ae=!0,fe.addEventListener("click",e=>{e.target.closest("#scroll-hint")&&window.scrollBy({top:Math.max(window.innerHeight*.92,240),behavior:"smooth"})}),window.addEventListener("scroll",I,{passive:!0}),window.addEventListener("resize",I))}function I(){const e=document.querySelector("#scroll-hint");if(!e)return;const t=document.documentElement,n=Math.max(0,t.scrollHeight-window.innerHeight),o=n>24,i=window.scrollY>=n-28,r=!B||!o||i;e.classList.toggle("is-hidden",r)}
