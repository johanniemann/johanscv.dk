(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();const Le={nav:{home:"Home",projects:"Projects",files:"Resume",contact:"Contact"},hero:{name:"Johan Niemann Husbjerg",title:"IT Architecture student shaping precise, human-centered systems."},welcome:{title:"Welcome",intro:"This site is a focused overview of my architecture profile, practical experience, and current projects.",point1:"Explore projects and implementation work.",point2:"Review my full Resume / CV structure.",point3:"Use Ask Johan for quick context.",continue:"Continue",passwordLabel:"Site access code",passwordPlaceholder:"Enter access code",passwordError:"Invalid access code. Please try again."},ask:{title:"Ask Johan",placeholder:"Ask about skills, projects, or architecture...",button:"Answer"},projects:{title:"Projects",intro:"Focused work in architecture, frontend systems, and product execution.",previewTitle:"Selected Work",previewIntro:"A snapshot of practical architecture and frontend execution.",cta:"View all projects"},files:{title:"Resume / CV",intro:"Education, experience, voluntary work, and qualifications."},fileScroller:{title:"Links and files",ariaLabel:"Links and files carousel"},resume:{previewTitle:"Resume Snapshot",previewIntro:"A structured view of my education, practical experience, and key competencies.",cta:"Open Resume / CV",downloadPdf:"Download resume as PDF",education:"Education",experience:"Work Experience",voluntary:"Voluntary Work",qualifications:"Qualifications",itSkills:"Core IT Skills",personalQualities:"Personal Qualities"},contact:{title:"Contact",intro:"Reach out directly by email, phone, or LinkedIn.",emailLabel:"Email",phoneLabel:"Phone",linkedinLabel:"LinkedIn",copyEmail:"Copy E-Mail",copyPhone:"Copy phonenumber",connectLinkedin:"Connect on LinkedIn",copied:"Copied"},playground:{title:"Experimental Playground",intro:"This is a sandbox page for testing ideas, UI experiments, and prototypes.",moreToComeTitle:"More To Come",moreToComeBody:"More experiments and interactive prototypes will be added here soon."},scrollHint:{label:"Scroll for more"},footer:{builtWith:"Built with Vite, Tailwind, and Vanilla JavaScript.",rights:"All rights reserved.",playground:"Experimental Playground"}},Pe={nav:{home:"Hjem",projects:"Projekter",files:"CV",contact:"Kontakt"},hero:{name:"Johan Niemann Husbjerg",title:"IT-arkitekturstuderende med fokus på præcise, menneskelige systemer."},welcome:{title:"Velkommen",intro:"Denne side giver et fokuseret overblik over min arkitekturprofil, praktiske erfaring og nuværende projekter.",point1:"Se projekter og konkret implementeringsarbejde.",point2:"Gennemgå mit fulde Resume / CV.",point3:"Brug Ask Johan for hurtig kontekst.",continue:"Fortsæt",passwordLabel:"Adgangskode til siden",passwordPlaceholder:"Indtast adgangskode",passwordError:"Ugyldig adgangskode. Prøv igen."},ask:{title:"Spørg Johan",placeholder:"Spørg om kompetencer, projekter eller arkitektur...",button:"Svar"},projects:{title:"Projekter",intro:"Fokuseret arbejde inden for arkitektur, frontend-systemer og produktudførelse.",previewTitle:"Udvalgt Arbejde",previewIntro:"Et udsnit af praktisk arkitektur og frontend-udførelse.",cta:"Se alle projekter"},files:{title:"Resume / CV",intro:"Uddannelse, arbejdserfaring, frivilligt arbejde og kvalifikationer."},fileScroller:{title:"Links og filer",ariaLabel:"Karusel med links og filer"},resume:{previewTitle:"CV overblik",previewIntro:"Et struktureret overblik over uddannelse, praktisk erfaring og væsentlige kompetencer.",cta:"Åbn Resume / CV",downloadPdf:"Download resume som PDF",education:"Uddannelse",experience:"Arbejdserfaring",voluntary:"Frivilligt arbejde",qualifications:"Kvalifikationer",itSkills:"Væsentlige IT-kundskaber",personalQualities:"Personlige kvaliteter"},contact:{title:"Kontakt",intro:"Kontakt mig direkte via e-mail, telefon eller LinkedIn.",emailLabel:"E-mail",phoneLabel:"Telefon",linkedinLabel:"LinkedIn",copyEmail:"Kopiér e-mail",copyPhone:"Kopiér telefonnummer",connectLinkedin:"Forbind på LinkedIn",copied:"Kopieret"},playground:{title:"Eksperimentelt Playground",intro:"Dette er en sandbox-side til at teste ideer, UI-eksperimenter og prototyper.",moreToComeTitle:"Mere På Vej",moreToComeBody:"Flere eksperimenter og interaktive prototyper bliver tilføjet her snart."},scrollHint:{label:"Scroll for mere"},footer:{builtWith:"Bygget med Vite, Tailwind og Vanilla JavaScript.",rights:"Alle rettigheder forbeholdes.",playground:"Eksperimentelt Playground"}},Q={en:Le,dk:Pe};function Te({route:e,t}){return`
  ...
  `}function z(e,t,n,o=""){const i=`nav-link nav-link-${e==="/"?"home":e.slice(1)} ${o}`.trim();return`<a class="${n===e?`${i} active`:i}" href="${e}" data-link>${t}</a>`}function Ie(e){return`
  ...
  `}function Ce(e){const t=document.querySelector("#theme-toggle");t&&t.addEventListener("click",e)}function Me(e){return`
  ...
  `}function xe(e){const t=document.querySelector("#language-toggle");t&&t.addEventListener("click",e)}function _e({t:e,theme:t,language:n}){const o=new Date().getFullYear();return`
  ...
  `}function Re(e){const t=document.querySelector("#welcome-continue"),n=document.querySelector("#welcome-access-code"),o=document.querySelector("#welcome-error");if(!t||!n)return;const r=()=>{const i=e(n.value.trim());if(i?.ok){o&&(o.textContent="");return}o&&(o.textContent=i?.message||""),n.focus(),n.select()};t.addEventListener("click",r),n.addEventListener("keydown",i=>{i.key==="Enter"&&r()})}const T={theme:"johanscv.theme",language:"johanscv.language"};let p={theme:localStorage.getItem(T.theme)||"dark",language:localStorage.getItem(T.language)||"en",route:"/"};ue(p);function m(){return p}function K(e){const t=p,n={...p,...e};Fe(t,n)&&(p=n,De(t,p)&&qe(),Oe(t,p)&&ue(p))}function qe(){localStorage.setItem(T.theme,p.theme),localStorage.setItem(T.language,p.language)}function ue(e){document.documentElement.dataset.theme=e.theme,document.documentElement.classList.toggle("dark",e.theme==="dark")}function De(e,t){return e.theme!==t.theme||e.language!==t.language}function Oe(e,t){return e.theme!==t.theme}function Fe(e,t){return e.theme!==t.theme||e.language!==t.language||e.route!==t.route}const pe=[{id:"spa-architecture",title:{en:"SPA Architecture Foundation",dk:"SPA Arkitekturgrundlag"},summary:{en:"Designed a lightweight Vanilla JS SPA with explicit routing, transition orchestration, and durable state boundaries.",dk:"Designede en letvægts Vanilla JS SPA med tydelig routing, overgangsorkestrering og robuste state-grænser."},tags:["Vite","Vanilla JS","Routing"]},{id:"design-system",title:{en:"Interaction-Led Design System",dk:"Interaktionsdrevet Designsystem"},summary:{en:"Built a restrained visual language with theme tokens, glass surfaces, motion hierarchy, and responsive rhythm.",dk:"Byggede et afdæmpet visuelt sprog med tematiske tokens, glasflader, motion-hierarki og responsiv rytme."},tags:["Tailwind","Theming","UX Motion"]},{id:"deployment-flow",title:{en:"GitHub Pages Deployment Flow",dk:"GitHub Pages Deploy-flow"},summary:{en:"Configured stable project-page deployment with base-path-safe assets and SPA fallback for deep links.",dk:"Konfigurerede stabil project-pages deployment med base-path-sikre assets og SPA fallback til deep links."},tags:["GitHub Pages","CI-ready","Reliability"]}];function Be({t:e}){return`
  ...
  `}const Ve="I focus on architecture thinking, frontend systems, and product-minded delivery.",Je="Recent work centers on SPA structure, interaction quality, and maintainable design systems.",Ne="I prioritize separation of concerns, explicit state, and measurable performance.",S={skills:Ve,projects:Je,architecture:Ne,default:"In this phase, I can answer on skills, projects, and architecture approach."},I="https://ask-johan-api.onrender.com".replace(/\/$/,""),me="johanscv.askJohanAccessCode",Z="Access code is required to use Ask Johan.",Ue="Ask Johan is waking up on Render free hosting. Please try again in 10-20 seconds.",We=25e3,D=2,ee=2200,Ke=42,Ge=24,Xe=1200,Ye=260,Qe=520,te={en:["What is your favorite dish?","When is your birthday?","Where do you live in Copenhagen?","What kind of IT architecture do you want to work with?","What is your strongest technical skill right now?","How do you approach system design decisions?","What have you learned from your current student job?","Which projects best represent your profile?","How do you balance UX quality and performance?","How do you work with data quality in practice?","How can we collaborate on a relevant opportunity?"],dk:["Hvad er din yndlingsret?","Hvornår har du fødselsdag?","Hvor bor du i København?","Hvilken type IT-arkitektur vil du arbejde med?","Hvad er din stærkeste tekniske kompetence lige nu?","Hvordan træffer du arkitektur- og designbeslutninger?","Hvad har du lært i dit nuværende studiejob?","Hvilke projekter repræsenterer dig bedst?","Hvordan balancerer du UX-kvalitet og performance?","Hvordan arbejder du med datakvalitet i praksis?","Hvordan kan vi samarbejde om en relevant mulighed?"]};let v=null,O=0;function fe({t:e}){const[t,n]=ze(e.ask.title);return`
  ...
  `}function ze(e="Ask Johan"){const t=String(e).trim();if(!t)return["Ask","Johan"];const n=t.split(/\s+/);if(n.length===1)return[n[0],""];const o=n.pop();return[n.join(" "),o]}function ge(e="en"){const t=document.querySelector("#ask-input"),n=document.querySelector("#ask-submit"),o=document.querySelector("#ask-answer");if(!t||!n||!o)return;dt(t,e),ct();const r=async()=>{const i=t.value.trim().toLowerCase();n.disabled=!0;try{const a=await Ze(i);await mt(o,a)}finally{n.disabled=!1}};n.addEventListener("click",r),t.addEventListener("keydown",i=>{i.key==="Enter"&&r()})}async function Ze(e){if(!e)return S.default;try{return await nt(e)}catch(t){return console.warn(at(t)),Ue}return et(e)}function et(e){return e.includes("skill")?S.skills:e.includes("project")?S.projects:e.includes("architect")?S.architecture:S.default}function tt(){const e=localStorage.getItem(me);return e&&e.trim()?e:""}async function nt(e){if(!I)throw new Error("VITE_API_BASE_URL is not configured.");const t=tt();if(!t)return Z;let n=null;for(let o=1;o<=D;o+=1)try{const r=await ot(e,t);if(r.status===401)return localStorage.removeItem(me),Z;if(!r.ok){const s=await it(r);if(st(r.status,o)){await ne(ee);continue}throw new Error(s)}const i=await r.json(),a=rt(i);if(!a)throw new Error("API returned an empty answer.");return a}catch(r){if(n=r,o<D&&lt(r)){await ne(ee);continue}throw r}throw n||new Error("API request failed.")}function ot(e,t){const n=new AbortController,o=window.setTimeout(()=>n.abort(),We);return fetch(`${I}/api/ask-johan`,{method:"POST",headers:{"Content-Type":"application/json","x-access-code":t},body:JSON.stringify({question:e}),signal:n.signal}).finally(()=>{window.clearTimeout(o)})}function rt(e){return typeof e?.answer!="string"?"":e.answer.trim()||""}async function it(e){try{const t=await e.json();if(typeof t?.answer=="string"&&t.answer.trim())return`${e.status} ${e.statusText}: ${t.answer.trim()}`}catch{}return`${e.status} ${e.statusText}: API request failed.`}function at(e){return e?.name==="AbortError"?"Ask Johan API error: request timed out.":`Ask Johan API error: ${e instanceof Error?e.message:String(e)}`}function st(e,t){return t>=D?!1:e===408||e===429||e>=500}function lt(e){if(!e)return!1;if(e.name==="AbortError")return!0;const t=String(e.message||"");return t.includes("Failed to fetch")||t.includes("NetworkError")}function ct(){if(!I)return Promise.resolve();const e=new AbortController,t=window.setTimeout(()=>e.abort(),1e4);return fetch(`${I}/health`,{method:"GET",signal:e.signal}).catch(()=>null).finally(()=>{window.clearTimeout(t)})}function dt(e,t){pt();const n=ut(te[t]||te.en),o=++O;let r=0,i=0,a=!1;const s=()=>{if(o!==O)return;const d=n[r];if(!a){if(i+=1,e.placeholder=d.slice(0,i),i>=d.length){a=!0,v=window.setTimeout(s,Xe);return}v=window.setTimeout(s,Ke);return}if(i-=1,e.placeholder=d.slice(0,Math.max(i,0)),i<=0){a=!1,r=(r+1)%n.length,v=window.setTimeout(s,Ye);return}v=window.setTimeout(s,Ge)};s()}function ut(e){const t=[...e];for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function pt(){v&&(window.clearTimeout(v),v=null),O+=1}async function mt(e,t){const n=String(t||""),o=e.offsetHeight;e.style.height=`${o}px`,e.textContent=n,e.classList.toggle("has-content",!!n.trim());const r=n.trim()?e.scrollHeight:0;e.offsetHeight,e.style.height=`${r}px`,await ft(e),e.style.height=n.trim()?"auto":"0px"}function ft(e){return new Promise(t=>{let n=!1;const o=()=>{n||(n=!0,e.removeEventListener("transitionend",r),t())},r=i=>{i.propertyName==="height"&&o()};e.addEventListener("transitionend",r),window.setTimeout(o,Qe+80)})}function ne(e){return new Promise(t=>{window.setTimeout(t,e)})}const oe=[{id:"cv",title:{en:"CV",dk:"CV"},description:{en:"Updated profile and experience summary.",dk:"Opdateret profil og erfaringsoversigt."},url:"/files/johan-niemann-husbjerg-cv.pdf",actionLabel:{en:"Download CV",dk:"Download CV"},actionType:"download",icon:"download"},{id:"linkedin",title:{en:"LinkedIn",dk:"LinkedIn"},description:{en:"Professional profile, education, and work history.",dk:"Professionel profil, uddannelse og arbejdserfaring."},url:"https://www.linkedin.com/in/johan-niemann-h-038906312/",actionLabel:{en:"Go to LinkedIn",dk:"Gå til LinkedIn"},actionType:"external",icon:"linkedin"},{id:"github",title:{en:"GitHub",dk:"GitHub"},description:{en:"Code repositories, projects, and technical work.",dk:"Kode-repositorier, projekter og teknisk arbejde."},url:"https://github.com/johanniemann",actionLabel:{en:"Go to GitHub",dk:"Gå til GitHub"},actionType:"external",icon:"github"},{id:"location",title:{en:"Location",dk:"Lokation"},description:{en:"Where I live in Copenhagen.",dk:"Hvor jeg bor i København."},url:"https://www.google.com/maps/place/Enghavevej+63,+1674+K%C3%B8benhavn/@55.665423,12.5330593,15z/data=!3m1!4b1!4m6!3m5!1s0x4652539dab759293:0xf1e50266a0d1baf1!8m2!3d55.6654113!4d12.5433376!16s%2Fg%2F11nnv8kwnj?entry=ttu&g_ep=EgoyMDI2MDIxMS4wIKXMDSoASAFQAw%3D%3D",actionLabel:{en:"Open in Maps",dk:"Åbn i Maps"},actionType:"external",icon:"location"}];function re(e,t,n=!1){const o=x(e.title,t),r=x(e.description,t),i=gt(e.url),a=n?'tabindex="-1"':'tabindex="0"',s=n?"file-card file-card-clone":"file-card",d=ht(e,n),l=kt(e.icon),u=x(e.actionLabel,t)||vt(e.actionType,o,t);return`
    <article class="${s}" ${a}>
  ...
  `}function gt(e){return e.startsWith("/")?`/johanscv.dk/${e.slice(1)}`:e}function ht(e,t){const n=[];return e.actionType==="download"?n.push("download"):n.push('target="_blank"','rel="noopener noreferrer"'),t&&n.push('tabindex="-1"'),n.join(" ")}function vt(e,t,n){return e==="download"?`Download ${t}`:n==="dk"?`Gå til ${t}`:`Open ${t}`}function kt(e){return e==="linkedin"?"in":e==="github"?bt():e==="location"?wt():yt()}function bt(){return`
  ...
  `}function x(e,t){return typeof e=="string"?e:e&&typeof e=="object"&&(e[t]||e.en||Object.values(e)[0])||""}let w=null,b=!1,y=null,P=null;const St=.018,L={interaction:1200,drag:900,wheel:1100};function At({t:e,language:t}){const n=oe.map(r=>re(r,t)).join(""),o=oe.map(r=>re(r,t,!0)).join("");return`
    ...
    <main class="page-stack">
      ...
      <section class="content-section section-reveal" id="projects-preview">
        ...
        <div class="projects-grid projects-grid-compact">
          ${pe.slice(0,2).map(n=>Pt(n,t)).join("")}
        </div>
  ...
  `}function Lt({language:e}){ge(e),$t()}function Pt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
    </article>
  `}const Tt=Object.freeze(Object.defineProperty({__proto__:null,mount:Lt,render:Et},Symbol.toStringTag,{value:"Module"}));function It({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="projects-grid section-reveal" aria-label="${e.projects.title}">
        ${pe.map(n=>Ct(n,t)).join("")}
      </section>
    </main>
  `}function Ct(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
      ...
      <section class="resume-section section-reveal" id="resume-qualifications">
        ...
        <div class="qual-grid">
          <article class="qual-card">
            ...
            <ul class="qual-list">
              ${n.qualifications.it.map(ae).join("")}
            </ul>
          </article>
          <article class="qual-card">
            <h4 class="qual-title">${e.resume.personalQualities}</h4>
            <ul class="qual-list">
              ${n.qualifications.personal.map(ae).join("")}
            </ul>
          </article>
        </div>
      </section>
  ...
  `}function ae(e){return`<li>${e}</li>`}const Ot=Object.freeze(Object.defineProperty({__proto__:null,render:Ht},Symbol.toStringTag,{value:"Module"}));function Ft({t:e}){return`
    <main class="page-stack">
      ...
      <section class="contact-stack section-reveal" aria-label="${e.contact.title}">
        ${_({label:e.contact.emailLabel,value:"johan.niemann.husbjerg@gmail.com",action:H({type:"button",icon:Vt(),text:e.contact.copyEmail,attrs:'data-copy="johan.niemann.husbjerg@gmail.com"'})})}
        ${_({label:e.contact.phoneLabel,value:"+45 60 47 42 36",action:H({type:"button",icon:Jt(),text:e.contact.copyPhone,attrs:'data-copy="+45 60 47 42 36"'})})}
  ...
  `}function Bt({t:e}){document.querySelectorAll("[data-copy]").forEach(n=>{n.dataset.defaultLabel=n.querySelector(".file-action-text")?.textContent||"",n.addEventListener("click",async()=>{if(n.dataset.busy==="true")return;const o=n.getAttribute("data-copy")||"";!o||!await Nt(o)||await Ut(n,e.contact.copied)})})}function _({label:e,value:t,action:n}){return`
  ...
  `}async function Nt(e){try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();const n=document.execCommand("copy");return document.body.removeChild(t),n}}async function Ut(e,t){const n=e.querySelector(".file-action-text");if(!n)return;const o=e.dataset.defaultLabel||n.textContent||"",r=180,i=900;e.dataset.busy="true",e.classList.add("is-label-hidden"),await R(r),n.textContent=t,e.classList.remove("is-label-hidden"),await R(i),e.classList.add("is-label-hidden"),await R(r),n.textContent=o,e.classList.remove("is-label-hidden"),e.dataset.busy="false"}function R(e){return new Promise(t=>{window.setTimeout(t,e)})}const Wt=Object.freeze(Object.defineProperty({__proto__:null,mount:Bt,render:Ft},Symbol.toStringTag,{value:"Module"}));function Kt({t:e,language:t}){return`
    <main class="page-stack">
  ...
  `}function Gt({language:e}){ge(e)}const Xt=Object.freeze(Object.defineProperty({__proto__:null,mount:Gt,render:Kt},Symbol.toStringTag,{value:"Module"}));function Yt(e){return`<div class="page-transition-enter">${e}</div>`}const se={"/":Tt,"/projects":Mt,"/resume":Ot,"/contact":Wt,"/playground":Xt},V="/johanscv.dk/",Qt=500,zt={"/files":"/resume"};function he(e){const t=e.startsWith("/")?e.slice(1):e;return`${V}${t}`}function le(e=window.location.pathname){if(!e.startsWith(V))return"/";const t=e.slice(V.length-1)||"/";return t.length>1&&t.endsWith("/")?t.slice(0,-1):t}function Zt({mountEl:e,renderFrame:t,pageContext:n,onRouteChange:o}){let r=!1;const i=()=>{const s=le(),d=zt[s]||s,l=se[d]||se["/"],u=n(d);s!==d&&history.replaceState({},"",he(d)),e.innerHTML=Yt(l.render(u)),l.mount&&l.mount(u),o(d),requestAnimationFrame(()=>{const k=e.querySelector(".page-transition-enter");k&&k.classList.add("is-visible")})},a=()=>{if(r)return;r=!0;const s=e.querySelector(".page-transition-enter");if(!s){i(),r=!1;return}s.classList.remove("is-visible"),s.classList.add("is-exiting"),window.setTimeout(()=>{i(),r=!1},Qt)};return document.addEventListener("click",s=>{const d=s.target.closest("[data-link]");if(!d)return;const l=d.getAttribute("href");!l||!l.startsWith("/")||(s.preventDefault(),l!==le()&&en(l,a))}),window.addEventListener("popstate",a),t(i),{refresh:a}}function en(e,t){history.pushState({},"",he(e)),t()}cn();const tn=document.querySelector("#app");tn.innerHTML=`
...
`;const ve="johanscv.askJohanAccessCode",ke="johanscv.siteAccessGranted",nn=500,on=.2,q=document.querySelector("#welcome-root"),rn=document.querySelector("#nav-root"),an=document.querySelector("#page-root"),sn=document.querySelector("#footer-root"),be=document.querySelector("#scroll-hint-root");let J=!1,ce=!1,N=!1,we=null,de=!1;pn()?ye():un();function ye(){N||(N=!0,we=Zt({mountEl:an,renderFrame:e=>{e(),dn()},pageContext:()=>{const e=m();return{t:$(e.language),language:e.language}},onRouteChange:e=>{K({route:e}),W(e),ln(),A()}}),Se(),U(),je(),gn(),W(m().route),A())}function Se(){const e=m(),t=$(e.language);rn.innerHTML=Te({route:e.route,t}),Ae()}function U(){const e=m(),t=$(e.language);sn.innerHTML=_e({t,theme:e.theme,language:e.language}),Ce(()=>{mn(),U()}),xe(()=>{fn(),Se(),W(m().route),U(),je(),A(),we?.refresh()})}function ln(){const e=document.querySelectorAll(".section-reveal"),t=new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:on});e.forEach((n,o)=>{n.style.transitionDelay=`${Math.min(o*70,240)}ms`,t.observe(n)})}function cn(){const e=new URL(window.location.href),t=e.searchParams.get("p");if(!t)return;const n=decodeURIComponent(t),[o,r]=n.split("&q="),i=r?`?${decodeURIComponent(r)}`:"",a=`${o}${i}${e.hash}`;window.history.replaceState(null,"",a)}function dn(){if(ce)return;ce=!0;let e=window.scrollY,t=!1;const n=()=>{t||(t=!0,window.requestAnimationFrame(()=>{const o=window.scrollY,r=o-e;o<36||r<-8?J=!1:r>8&&(J=!0),e=o,Ae(),t=!1}))};window.addEventListener("scroll",n,{passive:!0})}function Ae(){const e=document.querySelector("#navbar");e&&e.classList.toggle("nav-hidden",J)}function W(e){document.querySelectorAll(".nav-link").forEach(n=>{const o=n.getAttribute("href");n.classList.toggle("active",o===e)})}function un(){const e=m(),t=$(e.language);q.innerHTML=He({t}),document.body.classList.add("welcome-active");const n=q.querySelector(".welcome-screen");window.requestAnimationFrame(()=>{n?.classList.add("is-visible")}),Re(o=>$e(o)?(localStorage.setItem(ve,o),localStorage.setItem(ke,"true"),n?.classList.remove("is-visible"),n?.classList.add("is-exiting"),ye(),window.setTimeout(()=>{q.innerHTML="",document.body.classList.remove("welcome-active")},nn),{ok:!0}):{ok:!1,message:t.welcome.passwordError})}function $e(e){const t="family-friends-2026".trim();return e?t?e===t:!0:!1}function pn(){const e=localStorage.getItem(ke)==="true",t=localStorage.getItem(ve)?.trim()||"";return e&&$e(t)}function $(e){return Q[e]||Q.en}function mn(){const e=m().theme;K({theme:e==="dark"?"light":"dark"})}function fn(){const e=m().language;K({language:e==="en"?"dk":"en"})}function je(){const e=m(),t=$(e.language),n=Ee()?" is-hidden":"";be.innerHTML=`
  ...
  `}function gn(){de||(de=!0,be.addEventListener("click",e=>{e.target.closest("#scroll-hint")&&window.scrollBy({top:Math.max(window.innerHeight*.92,240),behavior:"smooth"})}),window.addEventListener("scroll",A,{passive:!0}),window.addEventListener("resize",A))}function A(){const e=document.querySelector("#scroll-hint");e&&e.classList.toggle("is-hidden",Ee())}function Ee(){const e=document.documentElement,t=Math.max(0,e.scrollHeight-window.innerHeight),n=t>24,o=window.scrollY>=t-28;return!N||!n||o}
