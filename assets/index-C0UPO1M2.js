(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function n(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=n(r);fetch(r.href,i)}})();const Te={nav:{home:"Home",projects:"Projects",files:"Resume",contact:"Contact"},hero:{name:"Johan Niemann Husbjerg",title:"IT Architecture student shaping precise, human-centered systems."},welcome:{title:"Welcome",intro:"This site is a focused overview of my architecture profile, practical experience, and current projects.",point1:"Explore projects and implementation work.",point2:"Review my full Resume / CV structure.",point3:"Use Ask Johan for quick context.",continue:"Continue",passwordLabel:"Site access code",passwordPlaceholder:"Enter access code",passwordError:"Invalid access code. Please try again."},ask:{title:"Ask Johan",placeholder:"Ask about skills, projects, or architecture...",button:"Answer"},projects:{title:"Projects",intro:"Focused work in architecture, frontend systems, and product execution.",previewTitle:"Selected Work",previewIntro:"A snapshot of practical architecture and frontend execution.",cta:"View all projects"},files:{title:"Resume / CV",intro:"Education, experience, voluntary work, and qualifications."},fileScroller:{title:"Links and files",ariaLabel:"Links and files carousel"},resume:{previewTitle:"Resume Snapshot",previewIntro:"A structured view of my education, practical experience, and key competencies.",cta:"Open Resume / CV",downloadPdf:"Download resume as PDF",education:"Education",experience:"Work Experience",voluntary:"Voluntary Work",qualifications:"Qualifications",itSkills:"Core IT Skills",personalQualities:"Personal Qualities"},contact:{title:"Contact",intro:"Reach out directly by email, phone, or LinkedIn.",emailLabel:"Email",phoneLabel:"Phone",linkedinLabel:"LinkedIn",copyEmail:"Copy E-Mail",copyPhone:"Copy phonenumber",connectLinkedin:"Connect on LinkedIn",copied:"Copied"},playground:{title:"Experimental Playground",intro:"This is a sandbox page for testing ideas, UI experiments, and prototypes.",moreToComeTitle:"More To Come",moreToComeBody:"More experiments and interactive prototypes will be added here soon."},scrollHint:{label:"Scroll for more"},footer:{builtWith:"Built with Vite, Tailwind, and Vanilla JavaScript.",rights:"All rights reserved.",playground:"Experimental Playground"}},Ie={nav:{home:"Hjem",projects:"Projekter",files:"CV",contact:"Kontakt"},hero:{name:"Johan Niemann Husbjerg",title:"IT-arkitekturstuderende med fokus på præcise, menneskelige systemer."},welcome:{title:"Velkommen",intro:"Denne side giver et fokuseret overblik over min arkitekturprofil, praktiske erfaring og nuværende projekter.",point1:"Se projekter og konkret implementeringsarbejde.",point2:"Gennemgå mit fulde Resume / CV.",point3:"Brug Ask Johan for hurtig kontekst.",continue:"Fortsæt",passwordLabel:"Adgangskode til siden",passwordPlaceholder:"Indtast adgangskode",passwordError:"Ugyldig adgangskode. Prøv igen."},ask:{title:"Spørg Johan",placeholder:"Spørg om kompetencer, projekter eller arkitektur...",button:"Svar"},projects:{title:"Projekter",intro:"Fokuseret arbejde inden for arkitektur, frontend-systemer og produktudførelse.",previewTitle:"Udvalgt Arbejde",previewIntro:"Et udsnit af praktisk arkitektur og frontend-udførelse.",cta:"Se alle projekter"},files:{title:"Resume / CV",intro:"Uddannelse, arbejdserfaring, frivilligt arbejde og kvalifikationer."},fileScroller:{title:"Links og filer",ariaLabel:"Karusel med links og filer"},resume:{previewTitle:"CV overblik",previewIntro:"Et struktureret overblik over uddannelse, praktisk erfaring og væsentlige kompetencer.",cta:"Åbn Resume / CV",downloadPdf:"Download resume som PDF",education:"Uddannelse",experience:"Arbejdserfaring",voluntary:"Frivilligt arbejde",qualifications:"Kvalifikationer",itSkills:"Væsentlige IT-kundskaber",personalQualities:"Personlige kvaliteter"},contact:{title:"Kontakt",intro:"Kontakt mig direkte via e-mail, telefon eller LinkedIn.",emailLabel:"E-mail",phoneLabel:"Telefon",linkedinLabel:"LinkedIn",copyEmail:"Kopiér e-mail",copyPhone:"Kopiér telefonnummer",connectLinkedin:"Forbind på LinkedIn",copied:"Kopieret"},playground:{title:"Eksperimentelt Playground",intro:"Dette er en sandbox-side til at teste ideer, UI-eksperimenter og prototyper.",moreToComeTitle:"Mere På Vej",moreToComeBody:"Flere eksperimenter og interaktive prototyper bliver tilføjet her snart."},scrollHint:{label:"Scroll for mere"},footer:{builtWith:"Bygget med Vite, Tailwind og Vanilla JavaScript.",rights:"Alle rettigheder forbeholdes.",playground:"Eksperimentelt Playground"}},Q={en:Te,dk:Ie};function Ce({route:e,t}){return`
  ...
  `}function z(e,t,n,o=""){const i=`nav-link nav-link-${e==="/"?"home":e.slice(1)} ${o}`.trim();return`<a class="${n===e?`${i} active`:i}" href="${e}" data-link>${t}</a>`}function Me(e){return`
  ...
  `}function xe(e){const t=document.querySelector("#theme-toggle");t&&t.addEventListener("click",e)}function _e(e){return`
  ...
  `}function He(e){const t=document.querySelector("#language-toggle");t&&t.addEventListener("click",e)}function Re({t:e,theme:t,language:n}){const o=new Date().getFullYear();return`
  ...
  `}function De(e){const t=document.querySelector("#welcome-continue"),n=document.querySelector("#welcome-access-code"),o=document.querySelector("#welcome-error");if(!t||!n)return;const r=()=>{const i=e(n.value.trim());if(i?.ok){o&&(o.textContent="");return}o&&(o.textContent=i?.message||""),n.focus(),n.select()};t.addEventListener("click",r),n.addEventListener("keydown",i=>{i.key==="Enter"&&r()})}const Oe="I focus on architecture thinking, frontend systems, and product-minded delivery.",Fe="Recent work centers on SPA structure, interaction quality, and maintainable design systems.",Be="I prioritize separation of concerns, explicit state, and measurable performance.",S={skills:Oe,projects:Fe,architecture:Be,default:"In this phase, I can answer on skills, projects, and architecture approach."},T="https://ask-johan-api.onrender.com".replace(/\/$/,""),pe="johanscv.askJohanAccessCode",Z="Access code is required to use Ask Johan.",Ve="Ask Johan is waking up on Render free hosting. Please try again in 10-20 seconds.",Je=25e3,D=2,ee=2200,Ne=42,Ue=24,We=1200,Ke=260,Ge=520,te={en:["What is your favorite dish?","When is your birthday?","Where do you live in Copenhagen?","What kind of IT architecture do you want to work with?","What is your strongest technical skill right now?","How do you approach system design decisions?","What have you learned from your current student job?","Which projects best represent your profile?","How do you balance UX quality and performance?","How do you work with data quality in practice?","How can we collaborate on a relevant opportunity?"],dk:["Hvad er din yndlingsret?","Hvornår har du fødselsdag?","Hvor bor du i København?","Hvilken type IT-arkitektur vil du arbejde med?","Hvad er din stærkeste tekniske kompetence lige nu?","Hvordan træffer du arkitektur- og designbeslutninger?","Hvad har du lært i dit nuværende studiejob?","Hvilke projekter repræsenterer dig bedst?","Hvordan balancerer du UX-kvalitet og performance?","Hvordan arbejder du med datakvalitet i praksis?","Hvordan kan vi samarbejde om en relevant mulighed?"]};let v=null,O=0,ne=!1;function me({t:e}){const[t,n]=Xe(e.ask.title);return`
  ...
  `}function Xe(e="Ask Johan"){const t=String(e).trim();if(!t)return["Ask","Johan"];const n=t.split(/\s+/);if(n.length===1)return[n[0],""];const o=n.pop();return[n.join(" "),o]}function fe(e="en"){const t=document.querySelector("#ask-input"),n=document.querySelector("#ask-submit"),o=document.querySelector("#ask-answer");if(!t||!n||!o)return;at(t,e);const r=async()=>{const i=t.value.trim().toLowerCase();n.disabled=!0;try{const a=await Ye(i);await ct(o,a)}finally{n.disabled=!1}};n.addEventListener("click",r),t.addEventListener("keydown",i=>{i.key==="Enter"&&r()})}async function Ye(e){if(!e)return S.default;try{return await ze(e)}catch(t){return console.warn(nt(t)),Ve}return Qe(e)}function Qe(e){return e.includes("skill")?S.skills:e.includes("project")?S.projects:e.includes("architect")?S.architecture:S.default}function ge(){const e=localStorage.getItem(pe);return e&&e.trim()?e:""}async function ze(e){if(!T)throw new Error("VITE_API_BASE_URL is not configured.");const t=ge();if(!t)return Z;let n=null;for(let o=1;o<=D;o+=1)try{const r=await Ze(e,t);if(r.status===401)return localStorage.removeItem(pe),Z;if(!r.ok){const s=await tt(r);if(ot(r.status,o)){await oe(ee);continue}throw new Error(s)}const i=await r.json(),a=et(i);if(!a)throw new Error("API returned an empty answer.");return a}catch(r){if(n=r,o<D&&rt(r)){await oe(ee);continue}throw r}throw n||new Error("API request failed.")}function Ze(e,t){const n=new AbortController,o=window.setTimeout(()=>n.abort(),Je);return fetch(`${T}/api/ask-johan`,{method:"POST",headers:{"Content-Type":"application/json","x-access-code":t},body:JSON.stringify({question:e}),signal:n.signal}).finally(()=>{window.clearTimeout(o)})}function et(e){return typeof e?.answer!="string"?"":e.answer.trim()||""}async function tt(e){try{const t=await e.json();if(typeof t?.answer=="string"&&t.answer.trim())return`${e.status} ${e.statusText}: ${t.answer.trim()}`}catch{}return`${e.status} ${e.statusText}: API request failed.`}function nt(e){return e?.name==="AbortError"?"Ask Johan API error: request timed out.":`Ask Johan API error: ${e instanceof Error?e.message:String(e)}`}function ot(e,t){return t>=D?!1:e===408||e===429||e>=500}function rt(e){if(!e)return!1;if(e.name==="AbortError")return!0;const t=String(e.message||"");return t.includes("Failed to fetch")||t.includes("NetworkError")}function it(){if(!T||ne||!ge())return Promise.resolve();ne=!0;const e=new AbortController,t=window.setTimeout(()=>e.abort(),1e4);return fetch(`${T}/health`,{method:"GET",signal:e.signal}).catch(()=>null).finally(()=>{window.clearTimeout(t)})}function at(e,t){lt();const n=st(te[t]||te.en),o=++O;let r=0,i=0,a=!1;const s=()=>{if(o!==O)return;const d=n[r];if(!a){if(i+=1,e.placeholder=d.slice(0,i),i>=d.length){a=!0,v=window.setTimeout(s,We);return}v=window.setTimeout(s,Ne);return}if(i-=1,e.placeholder=d.slice(0,Math.max(i,0)),i<=0){a=!1,r=(r+1)%n.length,v=window.setTimeout(s,Ke);return}v=window.setTimeout(s,Ue)};s()}function st(e){const t=[...e];for(let n=t.length-1;n>0;n-=1){const o=Math.floor(Math.random()*(n+1));[t[n],t[o]]=[t[o],t[n]]}return t}function lt(){v&&(window.clearTimeout(v),v=null),O+=1}async function ct(e,t){const n=String(t||""),o=e.offsetHeight;e.style.height=`${o}px`,e.textContent=n,e.classList.toggle("has-content",!!n.trim());const r=n.trim()?e.scrollHeight:0;e.offsetHeight,e.style.height=`${r}px`,await dt(e),e.style.height=n.trim()?"auto":"0px"}function dt(e){return new Promise(t=>{let n=!1;const o=()=>{n||(n=!0,e.removeEventListener("transitionend",r),t())},r=i=>{i.propertyName==="height"&&o()};e.addEventListener("transitionend",r),window.setTimeout(o,Ge+80)})}function oe(e){return new Promise(t=>{window.setTimeout(t,e)})}const I={theme:"johanscv.theme",language:"johanscv.language"};let p={theme:localStorage.getItem(I.theme)||"dark",language:localStorage.getItem(I.language)||"en",route:"/"};he(p);function m(){return p}function K(e){const t=p,n={...p,...e};ft(t,n)&&(p=n,pt(t,p)&&ut(),mt(t,p)&&he(p))}function ut(){localStorage.setItem(I.theme,p.theme),localStorage.setItem(I.language,p.language)}function he(e){document.documentElement.dataset.theme=e.theme,document.documentElement.classList.toggle("dark",e.theme==="dark")}function pt(e,t){return e.theme!==t.theme||e.language!==t.language}function mt(e,t){return e.theme!==t.theme}function ft(e,t){return e.theme!==t.theme||e.language!==t.language||e.route!==t.route}const ve=[{id:"spa-architecture",title:{en:"SPA Architecture Foundation",dk:"SPA Arkitekturgrundlag"},summary:{en:"Designed a lightweight Vanilla JS SPA with explicit routing, transition orchestration, and durable state boundaries.",dk:"Designede en letvægts Vanilla JS SPA med tydelig routing, overgangsorkestrering og robuste state-grænser."},tags:["Vite","Vanilla JS","Routing"]},{id:"design-system",title:{en:"Interaction-Led Design System",dk:"Interaktionsdrevet Designsystem"},summary:{en:"Built a restrained visual language with theme tokens, glass surfaces, motion hierarchy, and responsive rhythm.",dk:"Byggede et afdæmpet visuelt sprog med tematiske tokens, glasflader, motion-hierarki og responsiv rytme."},tags:["Tailwind","Theming","UX Motion"]},{id:"deployment-flow",title:{en:"GitHub Pages Deployment Flow",dk:"GitHub Pages Deploy-flow"},summary:{en:"Configured stable project-page deployment with base-path-safe assets and SPA fallback for deep links.",dk:"Konfigurerede stabil project-pages deployment med base-path-sikre assets og SPA fallback til deep links."},tags:["GitHub Pages","CI-ready","Reliability"]}];function gt({t:e}){return`
  ...
  `}function x(e,t){return typeof e=="string"?e:e&&typeof e=="object"&&(e[t]||e.en||Object.values(e)[0])||""}let w=null,b=!1,y=null,P=null;const At=.018,L={interaction:1200,drag:900,wheel:1100};function $t({t:e,language:t}){const n=re.map(r=>ie(r,t)).join(""),o=re.map(r=>ie(r,t,!0)).join("");return`
  ...
  `}function jt(){const e=document.querySelector("#file-scroller-viewport"),t=document.querySelector("#file-scroller-track");if(!e||!t)return;Et(),F(),b=!0;const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let o=!1,r=!1,i=null,a=!1,s=0,d=0,l=0,u=t.scrollWidth/2,k=performance.now();const j=()=>{t.style.transform=`translate3d(${-l}px, 0, 0)`},C=c=>{if(!u)return 0;const f=c%u;return f<0?f+u:f},M=c=>{if(!b||n||o)return;const f=c-k;k=c,l=C(l+f*At),j(),w=window.requestAnimationFrame(M)},g=()=>{B(),b=!1,F()},h=()=>{B(),!(b||n||o)&&(b=!0,k=performance.now(),w=window.requestAnimationFrame(M))},G=c=>{if(c.target.closest("a, button, input, textarea, select")){g(),y=window.setTimeout(h,L.interaction);return}r=!0,i=c.pointerId,a=!1,s=c.clientX,d=l,g(),e.setPointerCapture(i)},X=c=>{if(!r||c.pointerId!==i)return;const f=c.clientX-s;!a&&Math.abs(f)>6&&(a=!0,o=!0,e.classList.add("is-dragging")),o&&(l=C(d-f),j())},E=c=>{!r||c.pointerId!==i||(r=!1,i=null,o=!1,e.classList.remove("is-dragging"),e.hasPointerCapture(c.pointerId)&&e.releasePointerCapture(c.pointerId),y=window.setTimeout(h,a?L.drag:L.interaction))},Y=c=>{g(),l=C(l+c.deltaY*.8+c.deltaX),j(),y=window.setTimeout(h,L.wheel)};e.addEventListener("mouseenter",g),e.addEventListener("mouseleave",h),e.addEventListener("focusin",g),e.addEventListener("focusout",h),e.addEventListener("pointerdown",G),e.addEventListener("pointermove",X),e.addEventListener("pointerup",E),e.addEventListener("pointercancel",E),e.addEventListener("wheel",Y,{passive:!0}),P=()=>{e.removeEventListener("mouseenter",g),e.removeEventListener("mouseleave",h),e.removeEventListener("focusin",g),e.removeEventListener("focusout",h),e.removeEventListener("pointerdown",G),e.removeEventListener("pointermove",X),e.removeEventListener("pointerup",E),e.removeEventListener("pointercancel",E),e.removeEventListener("wheel",Y)},window.requestAnimationFrame(()=>{u=t.scrollWidth/2,j()}),n||(w=window.requestAnimationFrame(M))}function F(){w&&(window.cancelAnimationFrame(w),w=null)}function B(){y&&(window.clearTimeout(y),y=null)}function Et(){b=!1,P&&(P(),P=null),F(),B()}function Lt({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="content-section section-reveal" id="projects-preview">
        ...
        <div class="projects-grid projects-grid-compact">
          ${ve.slice(0,2).map(n=>Tt(n,t)).join("")}
        </div>
  ...
  `}function Pt({language:e}){fe(e),jt()}function Tt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
    </article>
  `}const It=Object.freeze(Object.defineProperty({__proto__:null,mount:Pt,render:Lt},Symbol.toStringTag,{value:"Module"}));function Ct({t:e,language:t}){return`
    <main class="page-stack">
      ...
      <section class="projects-grid section-reveal" aria-label="${e.projects.title}">
        ${ve.map(n=>Mt(n,t)).join("")}
      </section>
    </main>
  `}function Mt(e,t){const n=e.title[t]||e.title.en,o=e.summary[t]||e.summary.en;return`
    <article class="project-card">
      <h3 class="project-title">${n}</h3>
      <p class="project-summary">${o}</p>
      ...
      <section class="resume-section section-reveal" id="resume-qualifications">
        ...
        <div class="qual-grid">
          <article class="qual-card">
            ...
            <ul class="qual-list">
              ${n.qualifications.it.map(se).join("")}
            </ul>
          </article>
          <article class="qual-card">
            <h4 class="qual-title">${e.resume.personalQualities}</h4>
            <ul class="qual-list">
              ${n.qualifications.personal.map(se).join("")}
            </ul>
          </article>
        </div>
      </section>
  ...
  `}function se(e){return`<li>${e}</li>`}const Ft=Object.freeze(Object.defineProperty({__proto__:null,render:Rt},Symbol.toStringTag,{value:"Module"}));function Bt({t:e}){return`
    <main class="page-stack">
      ...
      <section class="contact-stack section-reveal" aria-label="${e.contact.title}">
        ${_({label:e.contact.emailLabel,value:"johan.niemann.husbjerg@gmail.com",action:H({type:"button",icon:Jt(),text:e.contact.copyEmail,attrs:'data-copy="johan.niemann.husbjerg@gmail.com"'})})}
        ${_({label:e.contact.phoneLabel,value:"+45 60 47 42 36",action:H({type:"button",icon:Nt(),text:e.contact.copyPhone,attrs:'data-copy="+45 60 47 42 36"'})})}
        ${_({label:e.contact.linkedinLabel,value:"linkedin.com/in/johan-niemann-h-038906312",action:H({type:"link",icon:"in",text:e.contact.connectLinkedin,attrs:'href="https://www.linkedin.com/in/johan-niemann-h-038906312/" target="_blank" rel="noopener noreferrer"'})})}
      </section>
    </main>
  `}function Vt({t:e}){document.querySelectorAll("[data-copy]").forEach(n=>{n.dataset.defaultLabel=n.querySelector(".file-action-text")?.textContent||"",n.addEventListener("click",async()=>{if(n.dataset.busy==="true")return;const o=n.getAttribute("data-copy")||"";!o||!await Ut(o)||await Wt(n,e.contact.copied)})})}function _({label:e,value:t,action:n}){return`
  ...
  `}function H({type:e,icon:t,text:n,attrs:o}){const r=e==="link"?"a":"button";return`
  ...
  `}async function Ut(e){try{return await navigator.clipboard.writeText(e),!0}catch{const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();const n=document.execCommand("copy");return document.body.removeChild(t),n}}async function Wt(e,t){const n=e.querySelector(".file-action-text");if(!n)return;const o=e.dataset.defaultLabel||n.textContent||"",r=180,i=900;e.dataset.busy="true",e.classList.add("is-label-hidden"),await R(r),n.textContent=t,e.classList.remove("is-label-hidden"),await R(i),e.classList.add("is-label-hidden"),await R(r),n.textContent=o,e.classList.remove("is-label-hidden"),e.dataset.busy="false"}function R(e){return new Promise(t=>{window.setTimeout(t,e)})}const Kt=Object.freeze(Object.defineProperty({__proto__:null,mount:Vt,render:Bt},Symbol.toStringTag,{value:"Module"}));function Gt({t:e,language:t}){return`
    <main class="page-stack">
  ...
  `}function Xt({language:e}){fe(e)}const Yt=Object.freeze(Object.defineProperty({__proto__:null,mount:Xt,render:Gt},Symbol.toStringTag,{value:"Module"}));function Qt(e){return`<div class="page-transition-enter">${e}</div>`}const le={"/":It,"/projects":xt,"/resume":Ft,"/contact":Kt,"/playground":Yt},V="/johanscv.dk/",zt=500,Zt={"/files":"/resume"};function ke(e){const t=e.startsWith("/")?e.slice(1):e;return`${V}${t}`}function ce(e=window.location.pathname){if(!e.startsWith(V))return"/";const t=e.slice(V.length-1)||"/";return t.length>1&&t.endsWith("/")?t.slice(0,-1):t}function en({mountEl:e,renderFrame:t,pageContext:n,onRouteChange:o}){let r=!1;const i=()=>{const s=ce(),d=Zt[s]||s,l=le[d]||le["/"],u=n(d);s!==d&&history.replaceState({},"",ke(d)),e.innerHTML=Qt(l.render(u)),l.mount&&l.mount(u),o(d),requestAnimationFrame(()=>{const k=e.querySelector(".page-transition-enter");k&&k.classList.add("is-visible")})},a=()=>{if(r)return;r=!0;const s=e.querySelector(".page-transition-enter");if(!s){i(),r=!1;return}s.classList.remove("is-visible"),s.classList.add("is-exiting"),window.setTimeout(()=>{i(),r=!1},zt)};return document.addEventListener("click",s=>{const d=s.target.closest("[data-link]");if(!d)return;const l=d.getAttribute("href");!l||!l.startsWith("/")||(s.preventDefault(),l!==ce()&&tn(l,a))}),window.addEventListener("popstate",a),t(i),{refresh:a}}function tn(e,t){history.pushState({},"",ke(e)),t()}dn();const nn=document.querySelector("#app");nn.innerHTML=`
...
`;const be="johanscv.askJohanAccessCode",we="johanscv.siteAccessGranted",on=500,rn=.2,q=document.querySelector("#welcome-root"),an=document.querySelector("#nav-root"),sn=document.querySelector("#page-root"),ln=document.querySelector("#footer-root"),ye=document.querySelector("#scroll-hint-root");let J=!1,de=!1,N=!1,Se=null,ue=!1;mn()?Ae():pn();function Ae(){N||(N=!0,it(),Se=en({mountEl:sn,renderFrame:e=>{e(),un()},pageContext:()=>{const e=m();return{t:$(e.language),language:e.language}},onRouteChange:e=>{K({route:e}),W(e),cn(),A()}}),$e(),U(),Le(),hn(),W(m().route),A())}function $e(){const e=m(),t=$(e.language);an.innerHTML=Ce({route:e.route,t}),je()}function U(){const e=m(),t=$(e.language);ln.innerHTML=Re({t,theme:e.theme,language:e.language}),xe(()=>{fn(),U()}),He(()=>{gn(),$e(),W(m().route),U(),Le(),A(),Se?.refresh()})}function cn(){const e=document.querySelectorAll(".section-reveal"),t=new IntersectionObserver(n=>{n.forEach(o=>{o.isIntersecting&&(o.target.classList.add("is-visible"),t.unobserve(o.target))})},{threshold:rn});e.forEach((n,o)=>{n.style.transitionDelay=`${Math.min(o*70,240)}ms`,t.observe(n)})}function dn(){const e=new URL(window.location.href),t=e.searchParams.get("p");if(!t)return;const n=decodeURIComponent(t),[o,r]=n.split("&q="),i=r?`?${decodeURIComponent(r)}`:"",a=`${o}${i}${e.hash}`;window.history.replaceState(null,"",a)}function un(){if(de)return;de=!0;let e=window.scrollY,t=!1;const n=()=>{t||(t=!0,window.requestAnimationFrame(()=>{const o=window.scrollY,r=o-e;o<36||r<-8?J=!1:r>8&&(J=!0),e=o,je(),t=!1}))};window.addEventListener("scroll",n,{passive:!0})}function je(){const e=document.querySelector("#navbar");e&&e.classList.toggle("nav-hidden",J)}function W(e){document.querySelectorAll(".nav-link").forEach(n=>{const o=n.getAttribute("href");n.classList.toggle("active",o===e)})}function pn(){const e=m(),t=$(e.language);q.innerHTML=qe({t}),document.body.classList.add("welcome-active");const n=q.querySelector(".welcome-screen");window.requestAnimationFrame(()=>{n?.classList.add("is-visible")}),De(o=>Ee(o)?(localStorage.setItem(be,o),localStorage.setItem(we,"true"),n?.classList.remove("is-visible"),n?.classList.add("is-exiting"),Ae(),window.setTimeout(()=>{q.innerHTML="",document.body.classList.remove("welcome-active")},on),{ok:!0}):{ok:!1,message:t.welcome.passwordError})}function Ee(e){const t="family-friends-2026".trim();return e?t?e===t:!0:!1}function mn(){const e=localStorage.getItem(we)==="true",t=localStorage.getItem(be)?.trim()||"";return e&&Ee(t)}function $(e){return Q[e]||Q.en}function fn(){const e=m().theme;K({theme:e==="dark"?"light":"dark"})}function gn(){const e=m().language;K({language:e==="en"?"dk":"en"})}function Le(){const e=m(),t=$(e.language),n=Pe()?" is-hidden":"";ye.innerHTML=`
  ...
  `}function hn(){ue||(ue=!0,ye.addEventListener("click",e=>{e.target.closest("#scroll-hint")&&window.scrollBy({top:Math.max(window.innerHeight*.92,240),behavior:"smooth"})}),window.addEventListener("scroll",A,{passive:!0}),window.addEventListener("resize",A))}function A(){const e=document.querySelector("#scroll-hint");e&&e.classList.toggle("is-hidden",Pe())}function Pe(){const e=document.documentElement,t=Math.max(0,e.scrollHeight-window.innerHeight),n=t>24,o=window.scrollY>=t-28;return!N||!n||o}
